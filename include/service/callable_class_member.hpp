...
struct CountArguments 
{
   ...
   * @used_args are the unpacked arguments.
   */  
template <typename class_type, typename member_function_pointer, typename return_type, typename... used_args>
  struct UnrollArguments 
  {
    ...
    struct LoopOver <R, T, remaining_args... >
    {
        ...
        used_args &... used) 
      {
        ...
        s >> l;
        UnrollArguments<class_type, member_function_pointer, return_type, used_args..., T>::template LoopOver< CountArguments<remaining_args... >::value,
    ...
    struct LoopOver<R, T> 
    {
        ...
        used_args &... used) 
      {
        ...
        s >> l;
        Invoke<class_type, member_function_pointer, return_type, used_args..., T>::MemberFunction(result, cls, m, used..., l);
      }
    };
    ...
    struct LoopOver<R> 
    {
        ...
        used_args &... used) 
      {
        ...
        Invoke<class_type, member_function_pointer, return_type, used_args...>::MemberFunction(result, cls, m, used...);
      }
    };    
  };
...
template< std::size_t COUNTER,  typename class_type, typename member_function_pointer, typename return_type,  typename... used_args>
  ...
  struct LoopOver 
  {
      ...
      used_args &... used) 
    {
      ...
      if( typeid( T ) != arg.type.get() ) {
        throw std::runtime_error("argument type mismatch for Callabale. TODO: Make custom exception" );
      }

      typename std::decay<T>::type *ptr = (typename std::decay<T>::type*)arg.pointer; 
      UnrollPointers<COUNTER-1, class_type, member_function_pointer, return_type,  used_args..., T>::template LoopOver< remaining_args... >::Unroll(result, cls, m, additional_args, s, used..., *ptr);
    }
  };
...
struct UnrollPointers<0, class_type, member_function_pointer, return_type, used_args...> 
{
  ...
  struct LoopOver 
  {
      ...
      used_args &... used) 
    {
      ...
      UnrollArguments<class_type, member_function_pointer, return_type, used_args...>::template LoopOver< CountArguments<remaining_args... >::value,
        remaining_args...>::Unroll(result, cls, m, s, used...);        
    }
  };
};
...
public:
  ...
  void operator()(serializer_type &result, serializer_type &params) override 
  {
    ...
    details::UnrollArguments<class_type, member_function_pointer, return_type>::template LoopOver<details::CountArguments<Args... >::value, Args...>::Unroll(
  ...
  void operator()(serializer_type &result, CallableArgumentList const &additional_args, serializer_type &params)  override
  {
    ...
    details::UnrollPointers<N, class_type, member_function_pointer, return_type>::template LoopOver< Args...>::Unroll(result, *class_, this->function_, additional_args, params);
  }
