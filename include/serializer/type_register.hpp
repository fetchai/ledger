...
template <typename T>
byte_array::ConstByteArray const TypeRegister<T>::name = "variant";
...
template <std::size_t E>
byte_array::ConstByteArray const TypeErrorRegister<E>::name = "variant";
...
byte_array::ConstByteArray const TypeErrorRegister<val>::name = symbol
                                                                        
//TypeNumberToName::value[ val ] = symbol                                
...
REGISTER_SERIALIZE_SYMBOL_TYPE("i8", int8_t, 8);
REGISTER_SERIALIZE_SYMBOL_TYPE("i8", char, 8);
