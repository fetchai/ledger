...
int main() {
...

  {
    ...
    schema::ConstraintType constraint{schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Lt, static_cast<float>(2.1)}}};
  ...
  // Now we make a MULTI-NODE QUERY that we expect to fail for the node 8080
  {
    ...
    schema::ConstraintType constraint{schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Lt, static_cast<float>(2.1)}}};
    schema::ConstraintType forwardingConstraint{schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Lt, static_cast<float>(-5.5)}}};
    schema::Constraint     longitude_c      { longitude, constraint};
    ...
    schema::ConstraintType  pass{schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Gt, static_cast<float>(-5.5)}}};
  ...
  {
    // Same constraint as before
    schema::ConstraintType longConst   { schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Gt, static_cast<float>(-4.0)}}};
    schema::ConstraintType latConst    { schema::ConstraintType::ValueType{schema::Relation{schema::Relation::Op::Lt, static_cast<float>(55.942)}}}; // should only hit Edinburgh and Cambridge
