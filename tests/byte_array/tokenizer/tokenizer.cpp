...
int main(int argc, char **argv) 
{
  ...
  SCENARIO("Testing individual consumers") {    
    ...
    SECTION("Any character") {      
      ...
      test_str =  "12$1adf)(SD)S(*ASdf 09812 4e12asd kalhsdak shd aopisfu q[wr iqrw'prkas'd;fkla;s'dfl;ak \"";
      EXPECT( test.Parse(test_str) );
      EXPECT( test.size() == test_str.size() );            
    };
    ...
    SECTION("Any character") {      
      ...
      EXPECT( equals( test, {E_INTEGER,E_CATCH_ALL, E_FLOATING_POINT, E_CATCH_ALL, E_FLOATING_POINT} )  );      
    };
