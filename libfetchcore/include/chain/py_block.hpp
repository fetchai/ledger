...
void BuildBasicBlock(std::string const &custom_name, pybind11::module &module) {
  ...
  py::class_<BasicBlock< P, H >, std::enable_shared_from_this<BasicBlock<P, H> >>(module, custom_name )
    ...
    .def("proof", ( const typename fetch::chain::BasicBlock< P, H >::proof_type & (BasicBlock< P, H >::*)() const ) &BasicBlock< P, H >::proof)
    .def("proof", ( typename fetch::chain::BasicBlock< P, H >::proof_type & (BasicBlock< P, H >::*)() ) &BasicBlock< P, H >::proof)
