...
void BuildLaggedFibonacciGenerator(std::string const &custom_name, pybind11::module &module) {
  ...
  py::class_<LaggedFibonacciGenerator< P, Q >>(module, custom_name )
    .def(py::init<  >())
    ...
    .def("Seed", ( uint64_t (LaggedFibonacciGenerator< P, Q >::*)(const fetch::random::LaggedFibonacciGenerator::random_type &) ) &LaggedFibonacciGenerator< P, Q >::Seed)
