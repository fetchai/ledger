...
void BuildChainManager(pybind11::module &module) {
  ...
  py::class_<ChainManager>(module, "ChainManager" )
    ...
    .def("chains", ( const fetch::protocols::ChainManager::chain_map_type & (ChainManager::*)() const ) &ChainManager::chains)
    .def("chains", ( fetch::protocols::ChainManager::chain_map_type & (ChainManager::*)() ) &ChainManager::chains)
