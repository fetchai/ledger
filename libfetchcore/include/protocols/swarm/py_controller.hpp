...
void BuildChainController(pybind11::module &module) {
  ...
  py::class_<ChainController>(module, "ChainController" )
    ...
    .def("with_blocks_do", ( void (ChainController::*)(std::function<void (ChainManager::shared_block_type, const ChainManager::chain_map_type &)>) const ) &ChainController::with_blocks_do)
    .def("with_blocks_do", ( void (ChainController::*)(std::function<void (ChainManager::shared_block_type, ChainManager::chain_map_type &)>) ) &ChainController::with_blocks_do)
