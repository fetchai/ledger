...
vm_benchmark_file = 'results/2019-11-09/vm_benchmark.csv'
opcode_list_file = 'results/2019-11-09/opcode_lists.csv'
output_path = 'results/2019-11-13/'
...
net_stderrs = {bm: (stddevs[bm] ** 2 + stddevs[base_inds[bm]] ** 2) ** 0.5 / n_reps ** 0.5 for bm in
               bm_inds.values()}
...
if make_tables:
    from vm_benchmark_tables import make_benchmark_table

    for name_str in ['String', 'Prim', 'Math', 'Array', 'Tensor', 'Crypto']:
        make_benchmark_table(bm_names, net_means, net_stderrs,
                             opcodes, base_inds, net_opcodes, n_reps, name_str)
...
print('\n', tabulate(string_fit_table, headers=['Benchmark (' + str(n_reps) + ' reps)',
...
print('\n', tabulate(array_fit_table, headers=['Benchmark (' + str(n_reps) + ' reps)',
...
headers = ['Benchmark (' + str(n_reps) + ' reps)'] + \
...
print('\n', tabulate(tensor_fit_table, headers=['Benchmark (' + str(n_reps) + ' reps)',
                                                # 'Opcodes',
