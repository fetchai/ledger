...
//#include "ledger/upow/old_synergetic_executor.hpp"
//#include "core/random/lfg.hpp"
//#include "ledger/upow/old_synergetic_contract_register.hpp"
//#include "ledger/upow/old_synergetic_miner.hpp"
...
//
//  char const *CONTRACT_NAME =
//      "zS6wg3ybTJYsItL/i1RBt7RYBYh/"
//      "BR05vxM7WDuvaGA=.Z+"
//      "ZQSog6NcP8LMGGpFHHWUeXRVXJT9AXZPvFWdrwT6iixAn7Q7KKKtiSviPWvPmT7KdKNbb8vs4oqg85PMsjaw==."
//      "synergetic";
//
...
//        fetch::ledger::SmartContractManager::CreateAddressForContract(contract_id);
...
//    executor_->OnDishonestWork(
//        [](Work /*work*/) { FAIL() << "This test is not supposed to have any dishonest work."; });
//
...
//          {
//            FAIL() << "There exists work in segment that performs better: " << w.score << " vs "
//                   << work.score;
//          }
//        }
//      }
...
//        // Creating test node
//        auto node =
//            miner_->CreateDAGTestData(static_cast<int32_t>(chain_->size()),
//                                      static_cast<int64_t>(random_() & ((1ul << 31) - 1ul)));
//        miner_->DetachContract();
//
