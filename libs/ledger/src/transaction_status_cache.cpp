...
TransactionStatus TransactionStatusCache::Query(v2::Digest digest) const
{
...
void TransactionStatusCache::Update(v2::Digest digest, TransactionStatus status, Timepoint const &now)
{
  FETCH_LOCK(mtx_);
