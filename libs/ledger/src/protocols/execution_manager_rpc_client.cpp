...
ExecutionManagerRpcClient::ExecutionManagerRpcClient(
...

{
  ...
  service_.reset(
      new fetch::service::ServiceClient(connection, network_manager));
}

ExecutionManagerRpcClient::Status ExecutionManagerRpcClient::Execute(
    block_type const &block)
{
  auto result =
      service_->Call(fetch::protocols::FetchProtocols::EXECUTION_MANAGER,
...
ExecutionManagerRpcClient::LastProcessedBlock()
{
  auto result =
      service_->Call(protocols::FetchProtocols::EXECUTION_MANAGER,
