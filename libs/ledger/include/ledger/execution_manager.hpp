...
public:
  ...
  using block_state_cache_type = std::unordered_map<block_digest_type, hash_type, crypto::CallableFNV>;
...
private:
  ...
  mutex_type state_archive_lock_; ///< guards both the state_archive_ and the block_state_cache_
