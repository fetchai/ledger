 ...
 * address. This checksum is calculated by hashing the address and selecting the first 4 bytes from
...
/**
 * Get the raw bytes fo the display variant of the address (with checksum)
 *
