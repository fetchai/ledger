...
inline VectorRegister<float, 128> approx_exp(
    VectorRegister<float, 128> const &x)
{
  ...
  const VectorRegister<float, 128> b(
...
inline VectorRegister<double, 128> approx_exp(
    VectorRegister<double, 128> const &x)
{
  ...
  const VectorRegister<double, 128> b(
