...
inline VectorRegister<fixed_point::fp32_t, 128> rotate_elements_left(VectorRegister<fixed_point::fp32_t, 128> const &x)
{
  VectorRegister<int32_t, 128> ret = rotate_elements_left<elements>(VectorRegister<int32_t, 128>(x.data()));
  return {ret.data()};
}

template<int32_t elements>
inline VectorRegister<fixed_point::fp32_t, 256> rotate_elements_left(VectorRegister<fixed_point::fp32_t, 256> const &x)
{
  VectorRegister<int32_t, 256> ret = rotate_elements_left<elements>(VectorRegister<int32_t, 256>(x.data()));
  return {ret.data()};
}
