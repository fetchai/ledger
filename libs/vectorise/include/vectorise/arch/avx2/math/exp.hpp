...
static const fixed_point::fp64_t one_over_LN2{fixed_point::fp64_t::_1/fixed_point::fp64_t::CONST_LN2};  //  1 / CONST_LN2

static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_INTEGER_MASK(static_cast<fixed_point::fp32_t>(integer_mask));
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_INTEGER_MASK(static_cast<fixed_point::fp32_t>(integer_mask));
...
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_CONST_LN2(fixed_point::fp32_t::CONST_LN2);
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_ONE_CONST_LN2(static_cast<fixed_point::fp32_t>(one_over_LN2));

static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_CONST_LN2(fixed_point::fp32_t::CONST_LN2);
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_ONE_CONST_LN2(static_cast<fixed_point::fp32_t>(one_over_LN2));

static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_EXP_P01(static_cast<fixed_point::fp32_t>(Exp_P01));
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_EXP_P02(static_cast<fixed_point::fp32_t>(Exp_P02));
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_EXP_P03(static_cast<fixed_point::fp32_t>(Exp_P03));
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_EXP_P04(static_cast<fixed_point::fp32_t>(Exp_P04));
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_EXP_P05(static_cast<fixed_point::fp32_t>(Exp_P05));

static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_EXP_P01(static_cast<fixed_point::fp32_t>(Exp_P01));
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_EXP_P02(static_cast<fixed_point::fp32_t>(Exp_P02));
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_EXP_P03(static_cast<fixed_point::fp32_t>(Exp_P03));
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_EXP_P04(static_cast<fixed_point::fp32_t>(Exp_P04));
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_EXP_P05(static_cast<fixed_point::fp32_t>(Exp_P05));
...
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_MAX_EXP(fixed_point::fp32_t::MAX_EXP);
static const VectorRegister<fixed_point::fp32_t, 128> FP32_128_MIN_EXP(fixed_point::fp32_t::MIN_EXP);
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_MAX_EXP(fixed_point::fp32_t::MAX_EXP);
static const VectorRegister<fixed_point::fp32_t, 256> FP32_256_MIN_EXP(fixed_point::fp32_t::MIN_EXP);
    ...
    VectorRegister<fixed_point::fp32_t, 128> const &x)
{
  ...
  VectorRegister<fixed_point::fp32_t, 128> e1 = VectorRegister<fixed_point::fp32_t, 128>(_mm_sllv_epi32(FP32_128_ONE.data(), shift_indexes));
  ...
  e.data() =
      _mm_blendv_epi8(e.data(), VectorRegister<fixed_point::fp32_t, 128>::MaskPosInf().data(),
                         mask_pos_inf.data());
  // Replace -inf in the final product using the mask
  e.data() =
      _mm_blendv_epi8(e.data(), VectorRegister<fixed_point::fp32_t, 128>::_0().data(),
    ...
    VectorRegister<fixed_point::fp32_t, 256> const &x)
{
  ...
  VectorRegister<fixed_point::fp32_t, 256> e1 = VectorRegister<fixed_point::fp32_t, 256>(_mm256_sllv_epi32(FP32_256_ONE.data(), shift_indexes));
  ...
  // Replace +inf in the final product using the mask
  e.data() =
      _mm256_blendv_epi8(e.data(), VectorRegister<fixed_point::fp32_t, 256>::MaskPosInf().data(),
                         mask_pos_inf.data());
  // Replace -inf in the final product using the mask
  e.data() =
      _mm256_blendv_epi8(e.data(), VectorRegister<fixed_point::fp32_t, 256>::_0().data(),
                         (mask_neg_inf | mask_underflow).data());
  // Replace NaN in the final product using the mask
  ...
  // Remove NaN/Inf elements from Overflow/Underflow mask
  mask_overflow.data() =
      _mm256_blendv_epi8(mask_overflow.data(), _mm256_setzero_si256(), (mask_nan | mask_pos_inf).data());
  mask_underflow.data() =
      _mm256_blendv_epi8(mask_underflow.data(), _mm256_setzero_si256(), (mask_nan | mask_neg_inf).data());
...
inline VectorRegister<float, 256> Exp(
  VectorRegister<float, 256> const &x)
{
...
inline VectorRegister<double, 256> Exp(
...
inline VectorRegister<int64_t, 256> Exp(
  VectorRegister<int64_t, 256> const &x)
{
...
inline VectorRegister<int32_t, 256> Exp(
  VectorRegister<int32_t, 256> const &x)
{
...
inline VectorRegister<int16_t, 256> Exp(
...
inline VectorRegister<int8_t, 256> Exp(
  VectorRegister<int8_t, 256> const &x)
{
