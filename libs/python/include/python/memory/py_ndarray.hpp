...
//    .def(py::init< RectangularArray<T> && >())
    ...
    .def("Rotate", ( void (RectangularArray< T >::*)(const double &, const double &, const double &, const typename RectangularArray< T >::type) ) &RectangularArray< T >::Rotate)
//    .def(py::self != py::self )
//    .def(py::self == py::self )
    .def("data", ( typename RectangularArray< T >::container_type & (RectangularArray< T >::*)() ) &RectangularArray< T >::data)
    .def("data", ( const typename RectangularArray< T >::container_type & (RectangularArray< T >::*)() const ) &RectangularArray< T >::data)
