...
void BuildReferenceAnnealer(pybind11::module &module) {
  ...
  py::class_<ReferenceAnnealer>(module, "ReferenceAnnealer" )
    ...
    .def("operator()", ( const fetch::optimisers::ReferenceAnnealer::cost_type & (ReferenceAnnealer::*)(const std::size_t &, const std::size_t &) const ) &ReferenceAnnealer::operator())
    .def("operator()", ( fetch::optimisers::ReferenceAnnealer::cost_type & (ReferenceAnnealer::*)(const std::size_t &, const std::size_t &) ) &ReferenceAnnealer::operator())
    ...
    .def("FindMinimum", ( double (ReferenceAnnealer::*)(fetch::optimisers::ReferenceAnnealer::state_type &, bool) ) &ReferenceAnnealer::FindMinimum)
    .def("At", ( const fetch::optimisers::ReferenceAnnealer::cost_type & (ReferenceAnnealer::*)(const std::size_t &, const std::size_t &) const ) &ReferenceAnnealer::At)
    .def("At", ( fetch::optimisers::ReferenceAnnealer::cost_type & (ReferenceAnnealer::*)(const std::size_t &, const std::size_t &) ) &ReferenceAnnealer::At)
