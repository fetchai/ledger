...
void BuildLayers(std::string const &custom_name, pybind11::module &module)
{
  ...
  //  .def("Dot", [](Variable<T> &a, Variable<T> &b) {
  //    return fetch::ml::ops::Dot(a, b);
  //  })
  //      .def("Relu", [](Variable<T> &a) {
  //        return fetch::ml::ops::Relu(a);
  //      })
  //      .def("ReduceSum", [](Variable<T> &a, std::size_t axis) {
  //        return fetch::ml::ops::Sum(a, axis);
  //      });
