...
void BuildConstByteArray(pybind11::module &module) {
  ...
  py::class_<ConstByteArray>(module, "ConstByteArray" )
    ...
    .def(py::init< const fetch::byte_array::ConstByteArray::self_type &, const std::size_t &, const std::size_t & >())
    ...
    .def("Match", ( bool (ConstByteArray::*)(const fetch::byte_array::ConstByteArray::self_type &, std::size_t) const ) &ConstByteArray::Match)
    .def("Match", ( bool (ConstByteArray::*)(const fetch::byte_array::ConstByteArray::container_type *, std::size_t) const ) &ConstByteArray::Match)
