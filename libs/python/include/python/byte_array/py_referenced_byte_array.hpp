...
void BuildByteArray(pybind11::module &module) {
  ...
  py::class_<ByteArray, fetch::byte_array::ConstByteArray>(module, "ByteArray" )
    ...
    .def("operator[]", ( fetch::byte_array::ConstByteArray::container_type & (ByteArray::*)(const std::size_t &) ) &ByteArray::operator[])
    .def("operator[]", ( const fetch::byte_array::ConstByteArray::container_type & (ByteArray::*)(const std::size_t &) const ) &ByteArray::operator[])
    .def("pointer", ( const fetch::byte_array::ConstByteArray::container_type * (ByteArray::*)() const ) &ByteArray::pointer)
    .def("pointer", ( fetch::byte_array::ConstByteArray::container_type * (ByteArray::*)() ) &ByteArray::pointer)
