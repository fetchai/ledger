...
void BuildHTTPResponse(pybind11::module &module) {
  ...
  py::class_<HTTPResponse>(module, "HTTPResponse" )
    .def(py::init< byte_array::ByteArray, const fetch::http::MimeType &, const fetch::http::Status & >())
    ...
    .def("mime_type", ( const fetch::http::MimeType & (HTTPResponse::*)() const ) &HTTPResponse::mime_type)
