...
void BuildKeyValueSet(pybind11::module &module)
{
  ...
  py::class_<KeyValueSet, std::map<byte_array::ConstByteArray, byte_array::ConstByteArray>>(
      ...
      .def("begin",
           (typename KeyValueSet::map_type::iterator(KeyValueSet::*)()) & KeyValueSet::begin)
      .def("begin", (typename KeyValueSet::map_type::const_iterator(KeyValueSet::*)() const) &
                        KeyValueSet::begin)
      .def("end", (typename KeyValueSet::map_type::iterator(KeyValueSet::*)()) & KeyValueSet::end)
      .def("end", (typename KeyValueSet::map_type::const_iterator(KeyValueSet::*)() const) &
                      KeyValueSet::end)
