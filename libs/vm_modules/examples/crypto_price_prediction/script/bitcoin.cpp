...
graph.AddFullyConnected("hidden_conv1D_1", "dropout_1", conv1D_2_filters, conv1D_2_input_channels,
    ...
    //// read in weights
    // var file_weights0 = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/hidden_dense_1/hidden_dense_1_12/kernel:0.csv";
    // var file_bias0    = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/hidden_dense_1/hidden_dense_1_12/bias:0.csv";
    // var file_weights1 = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/hidden_dense_2/hidden_dense_2_4/kernel:0.csv";
    // var file_bias1    = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/hidden_dense_2/hidden_dense_2_4/bias:0.csv";
    // var file_weights2 = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/output_dense/output_dense_12/kernel:0.csv";
    // var file_bias2    = System.Argv(0) +
    // "/output/keras_aluminium_px_last_us/model_weights/output_dense/output_dense_12/bias:0.csv";
    //
    ...
    main()
        ...
        if (System.Argc() != 3) print("Usage: VM SCRIPT_FILE PATH/TO/INPUT.csv /PATH/TO/LABEL.csv");
return;
endif
