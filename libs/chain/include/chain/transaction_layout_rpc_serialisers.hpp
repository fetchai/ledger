...
template <typename D>
struct MapSerialiser<chain::TransactionLayout, D>
{
public:
  ...
  static void Serialise(Constructor &map_constructor, Type const &tx)
  {
  ...
  static void Deserialise(MapDeserialiser &map, Type &tx)
  {
