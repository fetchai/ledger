...
class TransactionSerialiserTests : public ::testing::Test
{
protected:
  ...
  {
    return std::string{TransactionSerialiser::SerialisePayload(tx).ToHex()};
  }
...
// static data
TransactionSerialiserTests::Signers   TransactionSerialiserTests::signers_{};
TransactionSerialiserTests::Addresses TransactionSerialiserTests::addresses_{};

TEST_F(TransactionSerialiserTests, SimpleTransfer)
{
  ...
  ValidateTransaction(*tx, serialiser.data(), EXPECTED_DATA);

  // deserialise the transaction from the stream again
  Transaction output;
  serialiser >> output;
...
TEST_F(TransactionSerialiserTests, MultipleTransfers)
{
  static const std::string EXPECTED_DIGEST =
  ...
  // serialise the entire transaction
  TransactionSerialiser serialiser;
  serialiser << *tx;
...
TEST_F(TransactionSerialiserTests, ChainCodeExecute)
{
  static const std::string EXPECTED_DIGEST =
...
TEST_F(TransactionSerialiserTests, SmartContract)
{
  static const std::string EXPECTED_DIGEST =
...
TEST_F(TransactionSerialiserTests, CrazyNumOfSignatures)
{
  static const std::string EXPECTED_DIGEST =
  ...
  static const std::string EXPECTED_DATA =
      ...
      "f356529ec4a62c5edc63ef88e448d5ed8130038867cdd892d39de8a44004c5cda067175485a378f30132a20552df"
      "4013b07e06cc6de5eef88b524e368d9e3f4e8a10cfc34636579da763878b79e3ed6644626139b84f904a8f580ace"
      "320404689b19c958e89895fa0b4bb54df02ea4dc3f22753dcf3c24a6db2f991ed73fa03048ea6a1c5e2e5f699a0b"
      "71c5af8b856f1cda0431183989aba26c14f7e5aa4304c32891b7caa1c1a28c5be2308b581f0fe56e971c459002a0"
      "e1017534bfa46c5e3f37bab85513dcb31c05d99a6885cb414ed4986e22ff6ab8a613ea49494c9746048de98badc0"
      "2fc3bc168964a23dd5850f380c071ff8cf0d0f34f346a5d98cabf4cc6a169a4ce07120061580dbe5a0cd9e782caa"
      "ed251d5671d2af384cf8f0c4b304884f45ee337a98734b5cb3bdc3006b3ff13174fec3369b592e16bd922454af52"
      "bb5cb1d166c390a03cfca9f404409d7a32112b1be082be2d7971eb049d29139a048e9d0686542a264f3df5802153"
      "30085a6956722d16b21725087ea29ddb69e74420ca28a82486f47b4c7e9d3fe0d2e42ae6d0a9612ec615ad3fe01d"
      "84656b81df040b53b5426d9abd202b9d8ca14fb1788756e74b1ca617d6f7d2da01d82dc00a19386b11c0cc0d24b1"
      "4b19d6966da0d4c928fea5a5532fdfb964b47eca6883c1dc0461c0558174ffc0064a806e462a4221149c63f8d9f3"
      "b9616821def70a6a6d31bb2b85f5e32555f2f80e9991117798dd947c03f04662613c58bce5ee9be96aae4a04746b"
      "aee66bf76a6ece2e52700a1de8cc7345f43f45d29cce0a75af5f476f72ddb3cfa104871fcbafa1ed0fa8722a2307"
      "371586c30967048c568a0d5babc483c6048c2ed33dc02e2671b37f56b8802e546ac944491cbbb6730f151575ee40"
      "68f65a142462d7d5262db5fb9ea1ba67c10eed75af83ebe433fbb42450dc3185efc6d2042df73374fdc93288108e"
      "e18cb71d108f5f892c22442813926838bfb7de999c29eaf0eb8e1b3c8a003a98729225a66fb25fd86c285ebae3fa"
      "9bece950e4a2074704dd00261cc313e723cc952d7db4cbef93a87af5e87687a1e4004034d6e6a10313a5d11d0239"
      "d693b6ea3d97ba5b96756ad08b175c0196548e0a815344e3ec14ee043b34f939a6d75a4cf5c5e601b70211593812"
      "791078959b45c750e736d9f80d04e49f0f8f29614fcfc157a2e6fd8d04ed5a39ec6fc6e84535cd96a2160e324e84"
      "0456717f8757576d247e69c51a7b83a65e2daebe0279ca83d8c0bc861362b5b3b1be7c5c71bc5b1e01e050eecf7e"
      "187b7beae112f346e4634b68ce7a781bd8889b0442f7ad952ae8525995a86d0bb6d0fed17e84ed21d85c3f5114a2"
      "34fb90484e948f8f29a32913235daa0d129c80ac1588049cf3fc76a88b3f92b9fb92493cd8ab042fd124090cf781"
      "de0e9b0523430fc9b4348a46cc78d95d0c706c7d37a5f97c8e37ca2842c0a9cd974b7dd8b2aefd48fe02fb63847f"
      "da2e4a7fa3f1e975b0f22c04f27c91bb41b52d611691dfd1fc607c54427f3431479208f401902d606a2a9a3af619"
      "22e169c6204abf10984d7818359a079d69b6208a219d502bb987a4c86e9a04543d969e5af21bbdf5a6abaa253b48"
      "ab45d5a7a8e31c3bbfa0a08514365a42c7100bdbdd1584e3705a7111bbbca9f02b8446275147dd30359805ede4b8"
      "bd4f5404da698aaf05d63a0282fde44a1df2b8b7725bb5f9d478e140c7130af1350e780296c1a23f774457fb0521"
      "4144d43e971943aa41aeac9042167a5423c0cd27ca6d0471dd5333f01f2bce82b99ee45834d7140032d4ee3eb8f4"
      "bd0c6d0f856f3483b9c12af4eb052450aa062cebda3e7ae5e1a018d3767a5a9c1e5a602132be26ac0b04514071df"
      "9ecaf61f0fa833088fe4e1a58440e801871cdd2dee57fceeaa12fb313ad0a810c56083d557ec0605820ccc4de88a"
      "80b5f6b7a22d5b9caad29c299ab304792638a296d2b5175fab84dd7db39dfdb9855fcf41a496a199341d259b2f8d"
      "51bf3e698f4d2397289665e7c7034fa0ba3e80337cde2d31cc00c92c9bc21d325c048872ba2c4c9df79ddf43e8c7"
      "dcab6b72e4a9dc1bcc62f5a3bf72551e9d96b0122ec3727e3447e2ceb9f6dd9eb5e00722b7840895d67f649bb589"
      "b36299b24586049371ccda29b5b5fc1f2386c2e584ebf2b6bce80d3e31dc4bb74cfa2af2897553bed94a6f75254f"
      "b1d97a06eff7ce19cde3a0e667466e287b26b427b68ce09fc504a74f3dacedb467bcd2b1b526e3a8f9b9db6f32c0"
      "719ca65992fadb63352e4214b0d5a51fffe04e850353eba28562a28809c37a134ceee0694dec34c53e661a3b0412"
      "c3001a52aac6929d31dd33b9e4d155ba4b26609669ee953f1bb3aa64bb47eca34cdaca85a6c45ab5f8d68d4dd57c"
      "981bd158fa62534920d54210511b9780ab04349ff331a1bb30c1f839391f87662f280d5cb320c67d1349c491e4e2"
      "1bba3f96a0a12388528d2a1c348b41df441e9839235ae200d40ff0612f283df98fd3d30e04da1bb3c0a6891d924a"
      "8df490c7fe06ca08b72e6caf4bc304d60dba9b4ebabae56bbb26ac6293395b03bde7fcc0b74ca74599e4c0f6ca4b"
      "fc9718f7aaa157e2050453f5fb219e150a459f38133bb4d92eb9b4fcec3394db70f5cab6cf1695707497477c41b1"
      "d2bc302230f98cf8265eac11670fc8f580d88780d163d6e35c9825c6040224fcb38262122e5c7f94a6ad8fefbc47"
      "a26f8aac7cda16d1e31becf57d819f848bfa6658d96e5d1289ac33d9d736ddff0708e00ac169501a7f5b91e912ca"
      "1604d94741f8ca6148d41f84489dcd1649919a8f553e91564c7751babf0c40cf21a899dbfac1cb908399c1ab105e"
      "bf3fc83da37828d63c49e692ec75d2c767ddd988047bee541a7ad1947a4e2a65cc50417378ad82d6e418d212c21d"
      "fe58b1648f365e58268d536d9c18a0df3b2a275707c46da57d1967df84d6090e128298e59186b704d7616f86c66a"
      "a620481f4849c92d71bc8439a079ed399bc89b4a83a9bb619a401d62e2c65a4cc2bec9a1ad0a040bb65755900604"
      "e110e3a51b044a7eaef0507504e1a6dca41eeac77a7989571e4ca651cce6a8d6e374f43959d6247e099ede296e15"
      "35681627130d57b88dad52a5f82392c6f1b1ad79793abdc586d071a9c3c54d048aecbde5ee92b0f613e431dfadfe"
      "7b6cbb745e7c30e3b5ef9bf9ea396b5caf0588997b76ac2b3463a829ea5c828d61e24e4b52211874ce8cd9096e5e"
      "7eeba04e04a467fa1b599185babdbadefd4afa46449a04615da5f9046db10aa897ca59d9a20e2ae1391422b4f6ea"
      "ab33fae9f2b6600b8f9f8b3d1f3c004188c4ee4321e548040853301ef02e432fbf5d4334b62c03c61dc23c6bb8da"
      "9746868676b6b96419e88eb0def012d4b11bd67be5c8019b1d60cfb6af8a705c8b1bb0657fd8b928e796047ab40c"
      "7cc08fbbaf47f4ef4f3adee324e9afeb59354b3741cc83d6c50efb4691d7e94a107c5f790c4ab150439f4bb02ecb"
      "b33d808ad1e433f94953e38d5615dd046ce267a2ce7026f8ae7ad1afb344c59e9e19442cf418a049077787fc3c26"
      "f0f93b9212f5b4e4a1d8a9d7e9f3fefef5cbf6c240f048e1ccab1e9515eb60249db4047f6f91b6a5063dbc54f718"
      "9b50a34032b9428c1fc0fa78f2f7989a68db9a7139dbf6abf8752d587d0ea249339f27e4f8557c6c95bdc840fab7"
      "a2d1557d419fac04c4e3c17ff190472c8ceb0a7dedb51fa144fb15a4c88ef87287e282a31b6346175eb71711fd94"
      "3d0c0e11369f62e358b127786f0a4e5d9cd022b9ca95a5931c6a04fe95f3188634a0b8abc06a0c25c98137513fde"
      "6af868d351a6a45d5d32b80f3fcdc82b2f66e323fe4aa5abefcba40a70cadd0901be830df4368bc5b8c72496a704"
      "5b832c6c98e1447b3e7d3c82df704eecf5cb80581cd503b4a7dfa5c7bd2d111361ce85f9f4a2b59d1bdeda13a895"
      "38ae8ca47d44a37aef71951686625ed64b580498eb2f78f1dbb5f8fc0cc5c862c3e52f46bb8916e4fe2cc11f4f97"
      "dc609cded3ef3a196c7253f1b86dcc9e70076e33d8674f58cfedfcaca174fc3d88c42c51ca04deff8b97622f085a"
      "cfee073e7cc6829cf2a97d8acf568dec49965a5ec117d5657ed0a2d007647424f779c5bf7bd9699f7855db6f2520"
      "b449b5277d46ca5735a2041214583065ca7b6dd8e53ca75b90f4b3546b1592963e37bfa3381875a7f8fa66d347b6"
      "13108d2a6a373ac73bb86beaaf699ff43a44835a39dbacb6003af7852804a6853947e1e53db69fd44c81a5dda4c0"
      "f3e1a3090b57401f960d8d925658b942f5bd42c6da32fe7d2d3fd8d03495abe9df96e2374ca1e8521ecb718b5812"
      "629004d3bc4a38d64942de2eb48c124eb2e543d7e7bf3874c7204be53baee902147d8559ad6db9f147ae5091fb9b"
      "219915fe6629cc2f9f0a437010496b03e6f279dd9f047a2953edc8e3aab35de3330c39e2d924698cba3150b97837"
      "2388e4c1edc560243a29f9205d4fc06c9eea46928b49f24a9464fa5269a97ef22675c9570a2e3ff90436144197f0"
      "e92f5ff2fe8e7aff4387901f79cbdb27ce50a5c5e29f0436e44ab16312f8cc18ef05d7a0991a892a969782cc7f25"
      "9bb5fc0f5e9581918eda1287ef04b3352e123332a4611101c224c389758fdde9978b81134f001fa9043baae8ea76"
      "0d482b8300b9e078d1b08785d190419a7ee9385ba7f3d5456b9a5199f20a4cff04fca1c11751e326e34bffc764e6"
      "22f2bf3ddd407fbf3fd1f1a6b266678a4b306ae7d9f04acc82d8c11a35ca66cab38bf389dcdefb7005400cb32f09"
      "9873387f58042287db0f1c66f6715a2f0926bbe9cfe28e8b586a7eadbdd654cf3e5373fefa509a70c227abd07b04"
      "cc528d3513d8986edebe23b5800a19d0428fe8cb9502d1f80447fe7c83b4940a6821e29492e0d045d4ba2657323f"
      "1d1f45a35b16dd11afb03bb2ca27fa1ca49fd378ca1fd72d78d2543b117e8d53d2d3838db29c20c17ca13f041178"
      "57dd8d71d784fd64b5b6fe1b00b6dadfc1aec27fd298bc9076c02246db6e70165d6ed6cffcb2a1d1397b4273a4d8"
      "16355fcd1d452be857b1863122d340c7041012042e40ae9f042f9b37b8c5af3198d82d08a83363f437f2af8f425b"
      "8047a3192781ce23a3f649c168d1a978638e03e74ee83d747bf9fc0e6a587ad6b8e53e04ff29b948f4c7e095abf2"
      "b474e807d92b5b0ecf1037984c4dd909a1d90040e67c787453800e6a78afa53e2e709c55bd0810ec73a859685b43"
      "4839eceb268f3e27041e4c369fa0ebb67e9216188d5d2c7bdbc187c9050ce95135e4e312d12153c047cbb26230ed"
      "dfe0de5a7f0c32a85c0dd9371dc5af47b544fead8f0cfdb6ed67000408442b0b101603d87453c65b79d022cb3194"
      "0bc905c3880497671e7998de85c0b8491f6bfad00f5b05d9e9c42422c856b0eb12cf61be34c49660eb37710e2086"
      "040137433dbad339f259f614ca873cb37c317a591fdbd762caf5a3c835e94d9a2b5732ab0e0ea9a24eeb8e392820"
      "08372912787de433e13598b7a9b084689a8184042ae1ece357713d026f4b5cb1e0edd9c02b83e5fad2d714f091e9"
      "4a3adbefa57764561713b4e0c705745dddfa735e4a13891d4fc39898ed39b8b85dec976209a3041ff011559c7e12"
      "850b0950f8a501bbd9400a7c93b5b493a7257cbea61e63dcfd1ead67eac534b9fcde79b53a1363cf38f73abd3f83"
      "a232bd49f31603628dcb5c04c9961f3776e34e39d2debf721cc0c45d2ef149d5fadb63a709e5be8d0d5812fad741"
      "1396361653862076ae0262f836c18ef72651cd77a76a19abadd3453c36bd044b2d41db8b23c4a560dfac6a403280"
      "f36941b7015fb11accdac786c50bca650d6d5093b7530b2e73e7858ccc2a7a20e5756f3c8845be61d670c34a52ec"
      "02e59004eb8f891b997d41c78d40d82ea65a1a732d8d1220e751a1727f67dd572cd865961720d5ac8d330e4e7aa4"
      "068c63f1349817e68f3a42c212901d644d814ad6d64104b65b20312113618844dd784929c9261c9015523531ef26"
      "82670c1145929618e90f9509aa13e60a0c7a27fc0538c7315c880fadbe38f5eaa76a679bed7348c8a2044d2f1a60"
      "e490cde6abbc2a4d4a4c26d25e7210a8fb4e1fa5322718217f6a5a8bb67909b4e0bb1a1822d93799b8b8253057ee"
      "ae068cf2ef67dc729ef93874282c048e71966124b79ef0d7f3360539434fc2dd0d48193a1e7742cafbc7e3f796ea"
      "0c0546c01f771fba39de049ca23c6773a7c9b14102d95b662eeaa4c52f909c73c6";
...
TEST_F(TransactionSerialiserTests, ValidityRanges)
{
  static const std::string EXPECTED_DIGEST =
...
TEST_F(TransactionSerialiserTests, ContractWithSmallShardMask)
{
  static const std::string EXPECTED_DIGEST =
...
TEST_F(TransactionSerialiserTests, ContractWithLargeShardMask)
{
  static const std::string EXPECTED_DIGEST =
