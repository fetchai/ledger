...
class VickreyAuctionContract : public ledger::Contract
{
public:

  VickreyAuctionContract();
//    VickreyAuctionContract(BlockIdType start_block_id, BlockIdType end_block_id){va(start_block_id, end_block_id);};
