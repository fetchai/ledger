...
class DapSerialConversationTask
  : virtual public fetch::oef::base::TaskChainSerial<IN_PROTO, OUT_PROTO, DapInputDataType<MIDDLE_PROTO>,
                                   DapConversationTask<IN_PROTO, OUT_PROTO>>
{
public:
  using Parent   = fetch::oef::base::TaskChainSerial<IN_PROTO, OUT_PROTO, DapInputDataType<MIDDLE_PROTO>,
                                 DapConversationTask<IN_PROTO, OUT_PROTO>>;
