...
TEST(rbc_test, small_scale)
{
  ...
  Muddle muddle0{fetch::muddle::NetworkId{"TestNetwork"}, muddle_certificate_0, network_manager0,
                 true, true};
  ...
  Muddle muddle1{fetch::muddle::NetworkId{"TestNetwork"}, muddle_certificate_1, network_manager1,
                 true, true};
  ...
  Muddle muddle2{fetch::muddle::NetworkId{"TestNetwork"}, muddle_certificate_2, network_manager2,
                 true, true};
  ...
  Muddle muddle3{fetch::muddle::NetworkId{"TestNetwork"}, muddle_certificate_3, network_manager3,
                 true, true};
  ...
  while (muddle1.AsEndpoint().GetDirectlyConnectedPeers().size() != 3 or
         muddle2.AsEndpoint().GetDirectlyConnectedPeers().size() != 3 or
         muddle3.AsEndpoint().GetDirectlyConnectedPeers().size() != 3)
    ;
  {
  ...
  RBC::CabinetMembers cabinet{
      muddle_certificate_0->identity().identifier(), muddle_certificate_1->identity().identifier(),
      muddle_certificate_2->identity().identifier(), muddle_certificate_3->identity().identifier()};

  // Start at RBC for each muddle
  {
    uint32_t threshold{1};
    RBC      rbc0{muddle0.AsEndpoint(), muddle_certificate_0->identity().identifier(), cabinet,
             threshold};
    RBC      rbc1{muddle1.AsEndpoint(), muddle_certificate_1->identity().identifier(), cabinet,
             threshold};
    RBC      rbc2{muddle2.AsEndpoint(), muddle_certificate_2->identity().identifier(), cabinet,
             threshold};
    RBC      rbc3{muddle3.AsEndpoint(), muddle_certificate_3->identity().identifier(), cabinet,
             threshold};
