...
namespace rbc {
    ...
    public:
        ...
        explicit RBC(Endpoint &endpoint, ConstByteArray address, uint32_t num_parties);
    ...
    private:
        ...
        uint32_t const id_;              ///< Should this match BLS ID (derived from muddle address?)
