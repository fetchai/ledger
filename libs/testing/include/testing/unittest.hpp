...
public:
  ...
  self_shared_type last()
  {
    return subcontexts_.back();
  }
...
#undef ADD_OP
  ...
  Expression const *left_hand_side() const
  {
    return lhs_;
  }
  Expression const *right_hand_side() const
  {
    return rhs_;
  }
...
inline ProgramInserter &last_inserter()
{
  return *inserted_programs.back();
}
}  // namespace details
