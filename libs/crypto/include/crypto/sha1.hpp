...
class SHA1 : public internal::StreamHasher<SHA1>
{
public:
  using BaseType = internal::StreamHasher<SHA1>;
...
private:
  ...
  internal::OpenSslDigestContext impl_{internal::OpenSslDigestType::SHA1};
