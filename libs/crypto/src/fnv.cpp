...
namespace {
  ...
  static_assert(hash_size == 4 || hash_size == 8, "Hash size (= sizeof(std::size_t)) must be either 4 or 8 bytes.");

  constexpr FNV::context_type fnv_prime = hash_size == 4 ? (1ull<<24) + (1ull<<8) + 0x93ull : (1ull<<40) + (1ull<<8) + 0xb3ull;
