...
TEST(BlockCipherTests, BasicAes256CbcTest)
{
  ...
  ASSERT_TRUE(BlockCipher::Encrypt(BlockCipher::AES_256_CBC, key, iv, plain_text, cipher_text));

  ConstByteArray recovered_text{};
  ASSERT_TRUE(BlockCipher::Decrypt(BlockCipher::AES_256_CBC, key, iv, cipher_text, recovered_text));
