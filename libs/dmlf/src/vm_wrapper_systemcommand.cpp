...
void dispatchString(const std::string &data, VmWrapperInterface::OutputHandler func,
...
void dispatch(std::string &out, VmWrapperInterface::OutputHandler func, const std::string &name,
              bool flush)
{
  while (1)
  {
