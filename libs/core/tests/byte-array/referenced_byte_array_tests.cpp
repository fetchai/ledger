...
#include <gtest/gtest.h>
    ...
    TEST(reference_byte_array_gtest , testing_that_instantiation_of_ByteArray_is_done_by_referencee_and_NOT_by_value)
    {
      char const *base    = "hello world";
      ByteArray   str(base);
      ByteArray cba{base};
    ...
    TEST(reference_byte_array_gtest , testing_assignment_from_ByteArray_is_done_by_referencee_and_NOT_by_value)
    {
      char const *base    = "hello world";
      ByteArray   str(base);
      ByteArray cba{base};
