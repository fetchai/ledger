...
TYPED_TEST(ShuffleTest, lfg_test)
{
  ...
  std::vector<TypeParam> gt{static_cast<TypeParam>(0), static_cast<TypeParam>(3),
                            static_cast<TypeParam>(6), static_cast<TypeParam>(5),
                            static_cast<TypeParam>(9), static_cast<TypeParam>(7),
                            static_cast<TypeParam>(4), static_cast<TypeParam>(2),
                            static_cast<TypeParam>(8), static_cast<TypeParam>(1)};
