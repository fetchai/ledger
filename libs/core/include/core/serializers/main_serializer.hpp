...
public:
  ...
  template <typename T>
  typename IgnoredSerializer<T, self_type>::DriverType &operator<<(T const &)
  {
    return *this;
  }

  template <typename T>
  typename IgnoredSerializer<T, self_type>::DriverType &operator>>(T &)
  {
    return *this;
  }

  template <typename T>
  typename ForwardSerializer<T, self_type>::DriverType &operator<<(T const &val)
  {
  ...
  template <typename T>
  typename ForwardSerializer<T, self_type>::DriverType &operator>>(T &val)
  {
  ...
  template <typename T>
  typename FloatSerializer<T, self_type>::DriverType &operator<<(T const &val)
  {
  ...
  template <typename T>
  typename FloatSerializer<T, self_type>::DriverType &operator>>(T &val)
  {
  ...
  template <typename T>
  typename BinarySerializer<T, self_type>::DriverType &operator<<(T const &val)
  {
    BinarySerializer<T, MsgPackByteArrayBuffer >::Serialize(*this, val);
    return *this;
  }

  template <typename T>
  typename BinarySerializer<T, self_type>::DriverType &operator>>(T &val)
  {
    BinarySerializer<T, MsgPackByteArrayBuffer >::Deserialize(*this, val);
    return *this;
  }
  ...
  public:
    ...
    template<  typename V>
    bool ExpectKeyGetValue(uint8_t key, V &value) // TODO
    {
      ++pos_;
      if(pos_ > size_)
      {
