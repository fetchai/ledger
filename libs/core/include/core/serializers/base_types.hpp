...
template< typename D >
struct IntegerSerializer< int16_t, D > : public SignedIntegerSerializerImplementation< int16_t, D, 0xd1 > { };
template< typename D >
struct IntegerSerializer< int32_t, D > : public SignedIntegerSerializerImplementation< int32_t, D, 0xd2 > { };
template< typename D >
struct IntegerSerializer< int64_t, D > : public SignedIntegerSerializerImplementation< int64_t, D, 0xd4 > { };

template< typename D >
struct IntegerSerializer< uint8_t, D > : public UnsignedIntegerSerializerImplementation< uint8_t, D, 0xcc > { };
template< typename D >
struct IntegerSerializer< uint16_t, D > : public UnsignedIntegerSerializerImplementation< uint16_t, D, 0xcd > { };
template< typename D >
struct IntegerSerializer< uint32_t, D > : public UnsignedIntegerSerializerImplementation< uint32_t, D, 0xce > { };
template< typename D >
struct IntegerSerializer< uint64_t, D > : public UnsignedIntegerSerializerImplementation< uint64_t, D, 0xcf > { };
...
template< typename D >
struct BooleanSerializer<std::false_type, D> : public SpecialTypeSerializer<std::false_type, D, 0xc2>
{ };
...
struct FloatSerializer< float, D >
{
  ...
  static void Deserialize(Interface & interface, Type &val)
  {
      ...
      {
        throw SerializableException(std::string("expected float for deserialisation, but other type found."));
      }
      interface.ReadBytes(reinterpret_cast< uint8_t *>(&val), sizeof(val));
  }  
};
...
struct FloatSerializer< double, D >
{
  ...
  static void Deserialize(Interface & interface, Type &val)
  {
      ...
      {
        throw SerializableException(std::string("expected double for deserialisation, but other type found."));
      }
      interface.ReadBytes(reinterpret_cast< uint8_t *>(&val), sizeof(val));
  }
};
