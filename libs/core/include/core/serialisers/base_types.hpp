...
struct UnsignedIntegerSerialiserImplementation
{
  using Type       = T;
  using DriverType = D;

  template <typename Interface>
  static void Serialise(Interface &interface, Type val)
  {
  ...
  template <typename Interface>
  static void Deserialise(Interface &interface, Type &val)
  {
    uint8_t code;
  ...
  {
    auto serialise_val = platform::ToBigEndian(static_cast<ResultType>(val));
    interface.Allocate(sizeof(uint8_t) + sizeof(ResultType));
    interface.WriteByte(code);
    interface.WriteBytes(reinterpret_cast<uint8_t const *>(&serialise_val), sizeof(ResultType));
  }
...
struct SignedIntegerSerialiserImplementation
{
  using Type         = T;
  using DriverType   = D;
  ...
  static void Serialise(Interface &interface, Type val)
  {
    ...
    {
      UnsignedIntegerSerialiserImplementation<U, D>::template Serialise<Interface>(
  ...
  static void Deserialise(Interface &interface, Type &val)
  {
    ...
    {
      UnsignedType x;
      UnsignedIntegerSerialiserImplementation<U, D>::template Unpack<Interface, uint8_t>(interface,
                                                                                         x);
    ...
    {
      UnsignedType x;
      UnsignedIntegerSerialiserImplementation<U, D>::template Unpack<Interface, uint16_t>(interface,
                                                                                          x);
      val = static_cast<Type>(x);
      break;
    }
    ...
    {
      UnsignedType x;
      UnsignedIntegerSerialiserImplementation<U, D>::template Unpack<Interface, uint32_t>(interface,
                                                                                          x);
      val = static_cast<Type>(x);
      break;
    }
    ...
    {
      UnsignedType x;
      UnsignedIntegerSerialiserImplementation<U, D>::template Unpack<Interface, uint64_t>(interface,
                                                                                          x);
      val = static_cast<Type>(x);
      break;
    }
...
template <typename D>
struct IntegerSerialiser<int8_t, D>
  : public SignedIntegerSerialiserImplementation<int8_t, uint8_t, D>
{
};
template <typename D>
struct IntegerSerialiser<int16_t, D>
  : public SignedIntegerSerialiserImplementation<int16_t, uint16_t, D>
{
};
template <typename D>
struct IntegerSerialiser<int32_t, D>
  : public SignedIntegerSerialiserImplementation<int32_t, uint32_t, D>
{
};
template <typename D>
struct IntegerSerialiser<int64_t, D>
  : public SignedIntegerSerialiserImplementation<int64_t, uint64_t, D>
{
};

template <typename D>
struct IntegerSerialiser<uint8_t, D> : public UnsignedIntegerSerialiserImplementation<uint8_t, D>
{
};
template <typename D>
struct IntegerSerialiser<uint16_t, D> : public UnsignedIntegerSerialiserImplementation<uint16_t, D>
{
};
template <typename D>
struct IntegerSerialiser<uint32_t, D> : public UnsignedIntegerSerialiserImplementation<uint32_t, D>
{
};
template <typename D>
struct IntegerSerialiser<uint64_t, D> : public UnsignedIntegerSerialiserImplementation<uint64_t, D>
{
};

template <typename T, typename D, uint8_t C>
struct SpecialTypeSerialiser
{
  using Type       = T;
  using DriverType = D;
  enum
  ...
  template <typename Interface>
  static void Serialise(Interface &interface)
  {
    interface.Allocate(sizeof(uint8_t));
    interface.WriteByte(CODE);
  }
...
template <typename D>
struct BooleanSerialiser<std::true_type, D>
  : public SpecialTypeSerialiser<std::true_type, D, TypeCodes::BOOL_TRUE>
{
};

template <typename D>
struct BooleanSerialiser<std::false_type, D>
  : public SpecialTypeSerialiser<std::false_type, D, TypeCodes::BOOL_FALSE>
{
};

template <typename D>
struct BooleanSerialiser<bool, D>
{
  using DriverType = D;
  using Type       = bool;

  template <typename Interface>
  static void Serialise(Interface &interface, Type const &val)
  {
    if (val)
    {
      BooleanSerialiser<std::true_type, D>::Serialise(interface);
    }
    else
    {
      BooleanSerialiser<std::false_type, D>::Serialise(interface);
    }
  }
  ...
  static void Deserialise(Interface &interface, Type &val)
  {
    ...
    switch (code)
    {
    case BooleanSerialiser<std::true_type, D>::CODE:
      val = true;
      break;
    case BooleanSerialiser<std::false_type, D>::CODE:
      val = false;
      break;
    default:
...
template <typename D>
struct FloatSerialiser<float, D>
{
  using Type       = float;
  using DriverType = D;
...
template <typename D>
struct FloatSerialiser<double, D>
{
  using Type       = double;
  using DriverType = D;
...
struct StringSerialiserImplementation
{
public:
  using Type       = T;
  using DriverType = D;
...
template <typename D>
struct StringSerialiser<std::string, D> : public StringSerialiserImplementation<std::string, D>
{
};
template <typename D>
struct StringSerialiser<byte_array::ConstByteArray, D>
  : public StringSerialiserImplementation<byte_array::ConstByteArray, D>
{
};
template <typename D>
struct StringSerialiser<byte_array::ByteArray, D>
  : public StringSerialiserImplementation<byte_array::ByteArray, D>
{
};

template <typename V, typename D>
struct ArraySerialiser<std::vector<V>, D>
{
public:
...
template <typename V, typename D>
struct ArraySerialiser<std::deque<V>, D>
{
public:
...
template <typename V, typename D>
struct ArraySerialiser<std::set<V>, D>
{
public:
...
struct ArraySerialiser<std::unordered_set<V, H>, D>
{
public:
...
struct ArraySerialiser<std::array<V, N>, D>
{
public:
...
struct MapSerialiser<std::unordered_map<K, V, H, E>, D>
{
public:
...
struct MapSerialiser<std::map<K, V>, D>
{
public:
...
template <typename K, typename V, typename D>
struct ArraySerialiser<std::pair<K, V>, D>
{
public:
...
template <typename V, typename D>
struct ArraySerialiser<std::shared_ptr<V>, D>
{
public:
...
template <typename V, typename D>
struct ArraySerialiser<std::shared_ptr<const V>, D>
{
public:
...
template <typename V, typename D>
struct ArraySerialiser<std::unique_ptr<V>, D>
{
public:
...
struct ForwardSerialiser<fixed_point::FixedPoint<I, F>, D>
{
  using Type       = fixed_point::FixedPoint<I, F>;
  using DriverType = D;

  template <typename Interface>
  static void Serialise(Interface &interface, Type const &n)
  {
    interface << n.Data();
  }

  template <typename Interface>
  static void Deserialise(Interface &interface, Type &n)
  {
...
template <typename D>
struct ForwardSerialiser<fixed_point::FixedPoint<64, 64>, D>
{
public:
...
struct ArraySerialiser<vectorise::UInt<S>, D>
{
public:
  ...
  template <typename Constructor>
  static void Serialise(Constructor &array_constructor, Type const &u)
  {
  ...
  template <typename ArrayDeserialiser>
  static void Deserialise(ArrayDeserialiser &array, Type &u)
  {
