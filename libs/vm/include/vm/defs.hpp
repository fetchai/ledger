...
template <typename T>
struct IsPrimitive<T, typename std::enable_if_t<type_util::IsAnyOfV<
                          T, void, bool, int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t,
                          int64_t, uint64_t, std::size_t, float, double>>> : std::true_type
{
};
