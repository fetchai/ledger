...
inline bool IsZero(const float x) { return fabsf(x) < ABSOLUTE_FLT_TOLERANCE; }
inline bool IsZero(const double x) { return fabs(x) < ABSOLUTE_DBL_TOLERANCE; }
template <typename T>
...
inline bool IsNonZero(const float x) { return fabsf(x) > ABSOLUTE_FLT_TOLERANCE; }
inline bool IsNonZero(const double x) { return fabs(x) > ABSOLUTE_DBL_TOLERANCE; }
template <typename T>
...
inline bool IsEqual(const float a, const float b) { return fabsf(a - b) < Tolerance(a, b); }
inline bool IsEqual(const double a, const double b) { return fabs(a - b) < Tolerance(a, b); }
template <typename T>
...
inline bool IsNotEqual(const float a, const float b) { return fabsf(a - b) > Tolerance(a, b); }
inline bool IsNotEqual(const double a, const double b) { return fabs(a - b) > Tolerance(a, b); }
template <typename T>
...
inline bool IsLessThan(const float a, const float b) { return a < b - Tolerance(a, b); }
inline bool IsLessThan(const double a, const double b) { return a < b - Tolerance(a, b); }
template <typename T>
...
inline bool IsLessThanOrEqual(const float a, const float b) { return a < b + Tolerance(a, b); }
inline bool IsLessThanOrEqual(const double a, const double b) { return a < b + Tolerance(a, b); }
template <typename T>
...
inline bool IsGreaterThan(const float a, const float b) { return a > b + Tolerance(a, b); }
inline bool IsGreaterThan(const double a, const double b) { return a > b + Tolerance(a, b); }
template <typename T>
...
inline bool IsGreaterThanOrEqual(const float a, const float b) { return a > b - Tolerance(a, b); }
inline bool IsGreaterThanOrEqual(const double a, const double b) { return a > b - Tolerance(a, b); }
template <typename T>
