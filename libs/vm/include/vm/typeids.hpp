...
{
	return ((id == TypeId::Array_Bool) ||
		(id == TypeId::Array_Int8) ||
		(id == TypeId::Array_Byte) ||
		(id == TypeId::Array_Int16) ||
		(id == TypeId::Array_UInt16) ||
		(id == TypeId::Array_Int32) ||
		(id == TypeId::Array_UInt32) ||
		(id == TypeId::Array_Int64) ||
		(id == TypeId::Array_UInt64) ||
		(id == TypeId::Array_Float32) ||
		(id == TypeId::Array_Float64) ||
		(id == TypeId::Array_Matrix_Float32) ||
		(id == TypeId::Array_Matrix_Float64) ||
		(id == TypeId::Array_String) ||
		(id == TypeId::Array));
}
