...
struct TypeFunctionInvoker
{
  ...
  struct Invoker<parameter_offset, T, Ts...>
  {
                       ...
                       Used const & ...used)
    {
      ...
      using Type = typename TypeFunctionInvoker<ReturnType, TypeFunction, Used..., T>
                                                ::template Invoker<parameter_offset - 1, Ts...>;
                        ...
                        ReturnType (*f)(VM *, TypeId, Ts...))
{
  ...
  using TypeFunctionInvoker            = typename TypeFunctionInvoker<ReturnType,
