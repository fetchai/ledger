...
VM::VM(Module *module)
{
  std::vector<OpcodeHandlerInfo> array =
  {
    ...
    {Opcodes::VariablePrimitiveSubtractAssign, [](VM *vm){ vm->VariablePrimitiveSubtractAssign(); }},
    ...
    {Opcodes::ElementPrimitiveSubtractAssign,  [](VM *vm){ vm->ElementPrimitiveSubtractAssign(); }},
    ...
    {Opcodes::VariablePrimitiveMultiplyAssign, [](VM *vm){ vm->VariablePrimitiveMultiplyAssign(); }},
    ...
    {Opcodes::ElementPrimitiveMultiplyAssign,  [](VM *vm){ vm->ElementPrimitiveMultiplyAssign(); }},
