...
bool Object::SerializeTo(fetch::serializers::SizeCounter & /*counter*/)
{
  return false;
}
...
bool Object::SerializeTo(MsgPackSerializer & /*buffer*/, std::size_t /*size*/)
{
  vm_->RuntimeError("Serializer with size for " + GetUniqueId() + " is not defined.");
  return false;
}
