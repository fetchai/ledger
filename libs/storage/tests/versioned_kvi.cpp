...
//typedef KeyValueIndex< KeyValuePair< >, CachedRandomAccessStack< KeyValuePair< > > > kvi_type;
...
int main() 
{
  ...
  for(auto &b : bookmarks) {
    ...
    std::cout << "Reverting: " << b.value << " " << byte_array::ToBase64( b.key ) << " " <<  byte_array::ToBase64( key_index.Hash() ) << std::endl;
