...
//    };
//
//    using SignedIntSeq = pack::Pack<
// 	   VariantTypeId<TypeIds::Int8, TypeIds::Int16,
...
class ReturnZero
{
  ...
  template <class T>
  using IsNothrowConstructible = type_util::Or<std::is_void<T>, std::is_nothrow_constructible<T>>;
...
template <class CurrentId, class F, class... Args>
