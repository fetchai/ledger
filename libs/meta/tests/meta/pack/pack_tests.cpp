...
TEST(PackTests, BasicListInterface)
{
  ...
  using ConsConsDef =
      fetch::pack::ConsT<int, fetch::pack::ConsT<double, fetch::pack::Pack<char, float>>>;
  ...
  ASSERT_TYPE_EQ(fetch::pack::ConcatT<fetch::pack::Nil, char,
...
{
  ASSERT_TYPE_EQ(
      fetch::pack::TransformT<F, InputList>,
      fetch::pack::Pack<std::is_constructible<char>, std::is_constructible<int>,
                        std::is_constructible<NonConstructible>, std::is_constructible<double>>);
  ...
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<1>, InputList>,
                 fetch::pack::Pack<char>);
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<2>, InputList>,
                 fetch::pack::Pack<char, int>);
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<3>, InputList>,
                 fetch::pack::Pack<char, int, NonConstructible>);
  ...
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<0>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<1>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<2>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::TakeT<fetch::pack::SizeConstant<3>, fetch::pack::Nil>,
                 fetch::pack::Nil);

  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<0>, InputList>, InputList);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<1>, InputList>,
                 fetch::pack::Pack<int, NonConstructible, double>);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<2>, InputList>,
                 fetch::pack::Pack<NonConstructible, double>);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<3>, InputList>,
                 fetch::pack::Pack<double>);
  ...
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<0>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<1>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<2>, fetch::pack::Nil>,
                 fetch::pack::Nil);
  ASSERT_TYPE_EQ(fetch::pack::DropT<fetch::pack::SizeConstant<3>, fetch::pack::Nil>,
                 fetch::pack::Nil);
...
TEST(PackTests, ScalarFunctionals)
{
  ...
  ASSERT_TYPE_EQ(fetch::pack::TupleElementT<fetch::pack::SizeConstant<2>, InputList>,
                 NonConstructible);
  ...
  ASSERT_UNTRUE(
      fetch::pack::AnyV<std::is_constructible,
                        fetch::pack::Pack<NonConstructible, NonConstructible, NonConstructible>>);
...
template <class... Ts>
using Ctor =
    fetch::pack::Bind<fetch::pack::Pack, fetch::pack::Pack<char, int>>::template type<Ts...>;
...
TEST(PackTests, ScalarUtils)
{
  ...
  ASSERT_UNTRUE(
      fetch::pack::IsInvocableV<decltype(&f),
                                fetch::pack::TakeT<fetch::pack::SizeConstant<1>, InputList>>);
  ASSERT_UNTRUE(
      fetch::pack::IsInvocableV<decltype(&f),
                                fetch::pack::TakeT<fetch::pack::SizeConstant<2>, InputList>>);
  ASSERT_UNTRUE(
      fetch::pack::IsInvocableV<decltype(&f),
                                fetch::pack::TakeT<fetch::pack::SizeConstant<3>, InputList>>);
  ...
  ASSERT_TYPE_EQ(
      fetch::pack::InvokeResultT<decltype(&g),
                                 fetch::pack::TakeT<fetch::pack::SizeConstant<3>, InputList>>,
      int);
}
...
TEST(PackTests, Args)
{
  ASSERT_TYPE_EQ(fetch::pack::ArgsT<std::is_constructible<char, int, NonConstructible, double>>,
                 InputList);
