...
public:
  ...
  /*
   * Constructor for subscribe protocol attaches the functions to the protocol enums
   */
  SubscribeProtocol() : Protocol() , Node()
  {
    // We are allowing 'this' Node to register the feed new_message on the protocol
