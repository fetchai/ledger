...
public:
  ...
  using weak_ConnectionType        = std::weak_ptr<AbstractConnection>;
  ...
  using connection_map_type        = std::unordered_map<ConnectionHandleType, weak_ConnectionType>;
  ...
  void Enter(weak_ConnectionType const &wptr) override
  {
