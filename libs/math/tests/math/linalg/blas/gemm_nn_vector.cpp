...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector4)
{
  ...
  type alpha = type(0.9700463623185295);
  type beta  = type(0.08423731830032344);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.4044437582444409 0.5544475223802621 0.2676387250076072;
 0.5504881973061285 0.5277773638035311 0.27394701515041475;
 0.8208684021309556 0.6877825306805925 0.21110643473681567
	)");
...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector7)
{
  ...
  type alpha = type(0.8497358908360783);
  type beta  = type(0.561691057782103);
 ...
 0.690937738102466 0.3867353463005374 0.9367299887367345 0.13752094414599325
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.46841548343468503 1.2995845996373465 1.304797303401425 0.6849064625697179;
 0.23415888272601712 0.6611971422179714 0.7099552924992683 0.26425310928069273;
 0.6658761028137583 0.7337225877230921 1.002142119042459 0.5578072327869886;
 1.0160135797646306 1.0496387703742314 1.0719005468090974 0.8056490293055308
	)");
