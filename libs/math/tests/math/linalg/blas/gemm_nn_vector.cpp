...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector4) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemm_nn_vector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(0.6012041358597094);
  Type beta = Type(0.477710663835637);
...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector7) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemm_nn_vector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(0.9028918261999498);
  Type beta = Type(0.0020078087837498426);
