...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector4) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemm_nn_vector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(0.5166327277401022);
  Type beta = Type(0.7614181663732172);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Tensor< Type > refC = Tensor< Type >::FromString(R"(
  0.7377743507912607 0.8479480704732801 0.19559756657120075;
 0.5500423497879381 0.3641131317242097 0.7643609522152001;
 0.8838098232764783 0.6034095708156895 0.15797527524955302
  )");
...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector7) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemm_nn_vector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(0.6656021216912124);
  Type beta = Type(0.8086858356445521);
 ...
 0.690937738102466 0.3867353463005374 0.9367299887367345 0.13752094414599325
  ...
  Tensor< Type > refC = Tensor< Type >::FromString(R"(
  0.4002028464083224 1.3259556055692574 1.1403288735030372 0.6052618044003225;
 0.19845198104529052 0.7357873167143368 0.8059364749132392 0.21310681207451282;
 0.7103980167473596 0.6582397457084332 1.0228646756992472 0.5012237785858075;
 1.050604276885588 0.9647804044432438 1.1850070061736822 0.6817741036555746
  )");
