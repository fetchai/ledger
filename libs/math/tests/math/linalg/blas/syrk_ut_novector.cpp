...
TEST(blas_A_withA, blas_syrk_ut_novector3)
{
  ...
  double alpha = double(0.7393796358471815), beta = double(0.9210698963803712);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	1.2192089612339818 0.8440378895692882 1.226608809332649;
 0.8440378895692882 0.8233367875310008 1.0414647565992168;
 1.226608809332649 1.0414647565992168 0.7246725205933635
	)");
