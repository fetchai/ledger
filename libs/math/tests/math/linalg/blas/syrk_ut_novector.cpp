...
TEST(blas_A_withA, blas_syrk_ut_novector3) {
  ...
  double alpha = double(0.9378147311604674), beta = double(0.001856131886400103);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.1911160558232579 0.9566353950859 0.7577098062434942;
 0.9566353950859 0.9019576093343284 0.7433938267303062;
 0.7577098062434942 0.7433938267303062 0.6173166987184997
	)");
