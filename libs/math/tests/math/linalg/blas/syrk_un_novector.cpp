...
TEST(blas_A_withA, blas_syrk_un_novector3) {
  ...
  type alpha = type(0.5702977444752985);
  type beta = type(0.13936905533702626);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.2695401494776806 0.12843030708156095 0.5085507625230125;
 0.12843030708156095 0.5329085171228662 0.5422981328435172;
 0.5085507625230125 0.5422981328435172 0.940530482444293
	)");
