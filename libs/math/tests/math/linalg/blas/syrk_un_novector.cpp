...
TEST(blas_A_withA, blas_syrk_un_novector3)
{
  ...
  double alpha = double(0.29193874978028567), beta = double(0.29568993511227026);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.20631808982245825 0.08765658303103044 0.41383512025768954;
 0.08765658303103044 0.3001777878330905 0.3886965938842165;
 0.41383512025768954 0.3886965938842165 0.5395193328465917
	)");
