...
TEST(blas_A_withA, blas_syrk_un_novector3)
{
  ...
  double alpha = double(0.8740889855983941), beta = double(0.09121219087376353);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.37583730399149545 0.18488890406133712 0.6957018663042585;
 0.18488890406133712 0.8018457955358035 0.770566024088424;
 0.6957018663042585 0.770566024088424 1.4098666231968955
	)");
