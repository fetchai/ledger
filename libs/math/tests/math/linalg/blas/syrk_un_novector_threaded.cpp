...
TEST(blas_A_withA, blas_syrk_un_novector_threaded3)
{
  ...
  double alpha = double(0.45369463395683907), beta = double(0.4596594030311528);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.320674897444982 0.13623808073913174 0.6432231749471052;
 0.13623808073913174 0.4665152078698344 0.6041304760243698;
 0.6432231749471052 0.6041304760243698 0.8384883351923877
	)");
