...
TEST(blas_A_withA, blas_syrk_un_novector_threaded3)
{
  ...
  type alpha = type(0.8601664416673573), beta = type(0.01306646513840104);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.346489232968802 0.17445322513826333 0.6321448737595055;
 0.17445322513826333 0.7797144804490048 0.7203158509319405;
 0.6321448737595055 0.7203158509319405 1.3675635943570248
	)");
