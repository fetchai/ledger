...
TEST(blas_A_withA, blas_syrk_un_novector_threaded3) {
  ...
  double alpha = double(0.23057487059496629), beta = double(0.7533321134546435);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.321287763275963 0.12000109464070137 0.6825098994912746;
 0.12000109464070137 0.3005169169012647 0.564385013410113;
 0.6825098994912746 0.564385013410113 0.5606278313589688
	)");
