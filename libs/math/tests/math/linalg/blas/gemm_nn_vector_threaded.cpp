...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector_threaded4) {
  ...
  double alpha = double(0.1015541165195133), beta = double(0.5409819484493392);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.4302919501618715 0.4684867446267158 0.06742292274300582;
 0.24839283842314008 0.11691423533962683 0.48799133767163455;
 0.4176329741620402 0.24809566097869504 0.05592413626254136
	)");
...
TEST(blas_gemm_vectorised, blas_gemm_nn_vector_threaded7) {
  ...
  double alpha = double(0.25332581531928544), beta = double(0.2218285710720218);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.690937738102466 0.3867353463005374 0.9367299887367345 0.13752094414599325
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.14455498602829517 0.432856092700623 0.4064326813461483 0.21432841712292028;
 0.07202531983639829 0.22924820404278998 0.24849693595180578 0.07968190268443935;
 0.2263583230354247 0.2310554125495297 0.33384324065197113 0.1757764370284251;
 0.3404671362075843 0.33395040775737755 0.370493414544148 0.24766028424490577
	)");
