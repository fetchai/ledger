...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded3) {
  ...
  double alpha = double(0.4662953482917801), beta = double(0.6658128047431698);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.794775132655935 0.5405944635738636 0.8316841514957485;
 0.5405944635738636 0.5296086480377323 0.6988645309042056;
 0.8316841514957485 0.6988645309042056 0.47899918685128096
	)");
