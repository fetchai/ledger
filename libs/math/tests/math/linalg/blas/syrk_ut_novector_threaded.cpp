...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded3) {
  ...
  type alpha = type(0.7567302277131608);
  type beta = type(0.41307709196669373);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	1.0864938394856185 0.812116598962459 0.8930183134406567;
 0.812116598962459 0.778025247655697 0.8036550385613083;
 0.8930183134406567 0.8036550385613083 0.6046262952980113
	)");
