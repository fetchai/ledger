...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded3)
{
  ...
  double alpha = double(0.697744607896911), beta = double(0.9283998338677089);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	1.168586321718216 0.8022912824401702 1.198041451362013;
 0.8022912824401702 0.784198254036673 1.0121316193012764;
 1.198041451362013 1.0121316193012764 0.6991844224089623
	)");
