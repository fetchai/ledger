...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded3)
{
  ...
  type alpha = type(0.8038590170056582), beta = type(0.333957900036402);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	1.1222227834819207 0.8524543494758768 0.8768963512001507;
 0.8524543494758768 0.8136851289900033 0.801789245298215;
 0.8768963512001507 0.801789245298215 0.6151502270384648
	)");
