...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::THREADING> syrk_ut_novector_threaded;
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.36754854104910784 0.7202551656648148 0.5601494212235206
	...
	syrk_ut_novector_threaded(alpha, A, beta, C);
...
TEST(blas_A_withA, blas_syrk_ut_novector_threaded3) {
  ...
  double alpha = double(0.29419469787699626), beta = double(0.34044800519657337);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.47718370386127895 0.3332941891826571 0.47024271579260113;
 0.3332941891826571 0.32442284805105254 0.4014980637462733;
 0.47024271579260113 0.4014980637462733 0.28160415547362916
	)");
