...
TEST(blas_A_withA_vectorised, blas_syrk_ut_vector3)
{
  ...
  double alpha = double(0.821771918950316), beta = double(0.3735194947012943);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	1.1570141206220732 0.8745873407342074 0.9184142173302454;
 0.8745873407342074 0.8357368359271733 0.8355610076746642;
 0.9184142173302454 0.8355610076746642 0.637169971758189
	)");
