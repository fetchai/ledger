...
TEST(blas_A_withA_vectorised, blas_syrk_ut_vector3)
{
  ...
  double alpha = double(0.809681913690436), beta = double(0.8626695651888769);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	1.2906677719828719 0.9100333641539522 1.2433550726389777;
 0.9100333641539522 0.883807020512464 1.0682050834552843;
 1.2433550726389777 1.0682050834552843 0.7558001623342927
	)");
