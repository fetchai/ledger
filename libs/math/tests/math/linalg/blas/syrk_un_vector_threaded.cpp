...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE | platform::Parallelisation::THREADING> syrk_un_vector_threaded;
...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector_threaded3) {
  ...
  type alpha = type(0.29966478775471017);
  type beta = type(0.6284456000284939);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.31075647219070723 0.12171301267751189 0.6471151742352417;
 0.12171301267751189 0.34777579530730585 0.5598812964735199;
 0.6471151742352417 0.5598812964735199 0.6378829591726072
	)");
