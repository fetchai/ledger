...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded1)
{
 ...
 0.11951756833898089 0.1383506929615121 0.24508576903908225
  ...
  gemm_nn_novector_threaded(alpha, A, B, beta, C);

  ASSERT_TRUE(R.AllClose(C));
}

TEST(blas_DGEMM, blas_gemm_nn_novector_threaded2)
{
...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded3)
{
...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded4)
{
  ...
  type alpha = type(0.6376479348572193);
  type beta  = type(0.029676505470498937);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.24712362514661546 0.3446407491680358 0.1740263533530694;
 0.3526455015490421 0.34395054469236586 0.15789749362594185;
 0.5235714793013566 0.443602602906471 0.13713500852179264
	)");
...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded5)
{
...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded6)
{
...
TEST(blas_DGEMM, blas_gemm_nn_novector_threaded7)
{
  ...
  type alpha = type(-0.14699205998276277);
  type beta  = type(4.054405545038799);
 ...
 0.1014715428660321 0.6635017691080558 0.005061583846218687 0.16080805141749865 0.5487337893665861 0.6918951976926933 0.6519612595026005 0.22426930946055978 0.7121792213475359
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.4139065965912391 1.3348382947908317 0.3473275340168815 3.709771635469015 3.403518707609957 0.997458534334964 2.5623187890963908 3.254385328942826 2.072781005884956;
 2.057978269311852 0.9563872995109071 0.30781933459140143 3.612086552859519 3.557197570305019 2.538209482011814 1.299664224895266 1.3761775414615616 2.8297470381194674;
 3.5427930002647336 3.525103749701114 3.0840628340995835 2.585036856754993 0.2250873029968441 0.6133056087639536 3.598086927321916 2.4406354945771445 -0.06158384906108602;
 0.30709354925389426 2.621394193145156 -0.06451305687567893 0.6300716224027988 2.100498035466587 2.761460321152185 2.5859971038761733 0.8840067012708586 2.7735722615906937
	)");
