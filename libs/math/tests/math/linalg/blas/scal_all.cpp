...
TEST(blas_A_withA, blas_scal_all1) {
  ...
  using Type = double;Type alpha = Type(-1.4049016056886963);
...
TEST(blas_A_withA, blas_scal_all2) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> scal_all;
	// Compuing _x <= _alpha * _x
  using Type = double;Type alpha = Type(1.43787987191034);
...
TEST(blas_A_withA, blas_scal_all3) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> scal_all;
	// Compuing _x <= _alpha * _x
  using Type = double;Type alpha = Type(-4.622009168745431);
...
TEST(blas_A_withA, blas_scal_all4) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> scal_all;
	// Compuing _x <= _alpha * _x
  using Type = double;Type alpha = Type(-0.7895519240261688);
