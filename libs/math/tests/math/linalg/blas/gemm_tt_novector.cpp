...
TEST(blas_DGEMM, blas_gemm_tt_novector1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> gemm_tt_novector;
...
TEST(blas_DGEMM, blas_gemm_tt_novector4) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> gemm_tt_novector;
	// Compuing _C <= _alpha * T(_A) * T(_B) + _beta * _C
  using Type = double;Type alpha = Type(0.07935193597849055);
  Type beta = Type(0.1496814648777569);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Tensor< Type > refC = Tensor< Type >::FromString(R"(
  0.1456924215063093 0.12113208256162868 0.04207257432308109;
 0.12481397006787805 0.022124874330466813 0.19236504855285189;
 0.14036385841536242 0.058119457581041395 0.048812108355977143
  )");
