...
TEST(blas_DGEMM, blas_gemm_tt_novector4) {
  ...
  type alpha = type(0.08689211925672835);
  type beta = type(0.10292752203615119);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.11508375659165714 0.08561256292411597 0.04155537701576464;
 0.11481589060900158 0.01716187961146842 0.15801452705696162;
 0.11569468082016529 0.043464924482866665 0.04957473837156391
	)");
