...
TEST(blas_DGEMM, blas_gemm_tt_novector4)
{
  ...
  double alpha = double(0.09566102742454619), beta = double(0.8754977418769795);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.6823346024469822 0.6821015378358759 0.1021846082582097;
 0.39961929450822103 0.10720724301518762 0.8318037221240322;
 0.6024375385106012 0.3000561527909675 0.1030207796290278
	)");
