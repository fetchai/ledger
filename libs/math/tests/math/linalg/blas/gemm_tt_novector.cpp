...
TEST(blas_DGEMM, blas_gemm_tt_novector4)
{
  ...
  type alpha = type(0.8814498887690778), beta = type(0.04900035719278906);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.44198468010354997 0.10096663586042906 0.3478625148521287;
 0.8079989839590569 0.05879019773722477 0.744041149823876;
 0.5533747311393333 0.1116345090118875 0.4396474971333548
	)");
