...
TEST(blas_DGEMM, blas_gemm_tt_novector4) {
  ...
  double alpha = double(0.46205420869928715), beta = double(0.05945316175640514);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.25630404135338714 0.0789702002583726 0.18484909702546096;
 0.43565580744841365 0.034730282561691625 0.4191694834045886;
 0.31112496937685474 0.06969210363006134 0.23260850107606676
	)");
