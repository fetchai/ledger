...
TEST(blas_DGEMM, blas_gemm_tt_novector4) {
  ...
  double alpha = double(0.6821866370033862), beta = double(0.6697290375278219);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.8026592684289422 0.5654349274817984 0.3160054973490071;
 0.8518210124235555 0.11870665594070792 1.1211547310676118;
 0.8220805538981921 0.29546137929004224 0.38041597983034736
	)");
