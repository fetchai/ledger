...
TEST(blas_gemv, blas_gemv_t_vector3) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y = _alpha * T(_A) * _x + _beta * _y
  using type = double;type alpha = type(0.7408152300964884);
...
TEST(blas_gemv, blas_gemv_t_vector5) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y = _alpha * T(_A) * _x + _beta * _y
  using type = double;type alpha = type(0.3491599686166341);
...
TEST(blas_gemv, blas_gemv_t_vector6) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y = _alpha * T(_A) * _x + _beta * _y
  using type = double;type alpha = type(0.6188015793076526);
