...
TEST(blas_gemv, blas_gemv_t_vector3) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y <= _alpha * T(_A) * _x + _beta * _y
  using Type = double;Type alpha = Type(0.8466968918424935);
  Type beta = Type(0.9984653526388191);
  int n = 1;
  int m = 1;
...
TEST(blas_gemv, blas_gemv_t_vector5) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y <= _alpha * T(_A) * _x + _beta * _y
  using Type = double;Type alpha = Type(0.9659634804747055);
  Type beta = Type(0.1162572546765247);
  int n = 2;
  int m = 3;
...
TEST(blas_gemv, blas_gemv_t_vector6) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_t_vector;
	// Compuing _y <= _alpha * T(_A) * _x + _beta * _y
  using Type = double;Type alpha = Type(0.9085821925433354);
  Type beta = Type(0.34183731858760036);
  int n = -2;
  int m = -3;
