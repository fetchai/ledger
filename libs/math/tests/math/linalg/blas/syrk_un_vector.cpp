...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> syrk_un_vector;
...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector3) {
  ...
  type alpha = type(0.28298454503825865);
  type beta = type(0.2593116245529079);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.19167128769055752 0.0823006897609831 0.38245641394315666;
 0.0823006897609831 0.28763813087169665 0.3632518675196458;
 0.38245641394315666 0.3632518675196458 0.5159044199056074
	)");
