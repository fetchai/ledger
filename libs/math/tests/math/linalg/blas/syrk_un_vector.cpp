...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector3)
{
  ...
  double alpha = double(0.8740325712279159), beta = double(0.4398587135303412);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.48201737177271087 0.21893058908555432 0.9342164585693435;
 0.21893058908555432 0.8443429684331732 0.9431609140381918;
 0.9342164585693435 0.9431609140381918 1.4999998934596332
	)");
