...
TEST(blas_A_withA_vectorised, blas_syrk_un_vector3) {
  ...
  double alpha = double(0.9111144808184709), beta = double(0.8296800695140168);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.6155279411212167 0.26447095233769335 1.2278115423201252;
 0.26447095233769335 0.9254609477898494 1.1669654455376017;
 1.2278115423201252 1.1669654455376017 1.6596879667684719
	)");
