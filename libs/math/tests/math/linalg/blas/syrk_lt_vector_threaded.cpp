...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector_threaded3) {
  ...
  double alpha = double(0.9316575153387269), beta = double(0.896128027296257);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.4557070368680198 1.3446074962041625 0.7822898972029263;
 1.3446074962041625 1.00517266398246 1.5524674988246236;
 0.7822898972029263 1.5524674988246236 0.8446865286475647
	)");
