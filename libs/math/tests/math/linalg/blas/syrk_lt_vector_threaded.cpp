...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector_threaded3) {
  ...
  double alpha = double(0.7717445109238834), beta = double(0.4467058724789601);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.115798179175967 0.9837018868358272 0.6378493744492625;
 0.9837018868358272 0.7965658338159047 1.0171944808285933;
 0.6378493744492625 1.0171944808285933 0.6232042148432811
	)");
