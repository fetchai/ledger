...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector_threaded3)
{
  ...
  double alpha = double(0.45518762729719053), beta = double(0.00020448412383788916);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.5779204824990073 0.46432463305125504 0.3671606039134587;
 0.46432463305125504 0.4376986465014104 0.3605612819857787;
 0.3671606039134587 0.3605612819857787 0.2994471078948629
	)");
