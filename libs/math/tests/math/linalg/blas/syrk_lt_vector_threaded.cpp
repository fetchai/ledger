...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE | platform::Parallelisation::THREADING> syrk_lt_vector_threaded;
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.36754854104910784 0.7202551656648148 0.5601494212235206
	...
	syrk_lt_vector_threaded(alpha, A, beta, C);
...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector_threaded3) {
  ...
  type alpha = type(0.029367742617026904);
  type beta = type(0.06419601720019319);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.05683717878516826 0.05820747307445292 0.025895577727123833;
 0.05820747307445292 0.03607214916668148 0.08162540264472333;
 0.025895577727123833 0.08162540264472333 0.035928923920307346
	)");
