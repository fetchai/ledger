...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector3)
{
  ...
  type alpha = type(0.31206670535015724), beta = type(0.3357510941836934);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.22653600549033565 0.21060995731007132 0.2376433108967243;
 0.21060995731007132 0.3232748410114781 0.564287123867123;
 0.2376433108967243 0.564287123867123 0.581808320096225
	)");
