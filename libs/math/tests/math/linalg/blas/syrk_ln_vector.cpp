...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector3) {
  ...
  double alpha = double(0.691736583401691), beta = double(0.43606343739208764);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.4082729805031065 0.3312014833500987 0.5161698129526954;
 0.3312014833500987 0.6789720284595788 0.9705883509218162;
 0.5161698129526954 0.9705883509218162 1.2099051574097455
	)");
