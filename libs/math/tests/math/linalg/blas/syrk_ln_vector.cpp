...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector3)
{
  ...
  double alpha = double(0.4347493968597852), beta = double(0.08390192917967254);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.1986702077850433 0.12445758080766117 0.3178681659318309;
 0.12445758080766117 0.40352027442198296 0.43708897979912564;
 0.3178681659318309 0.43708897979912564 0.7112035959117842
	)");
