...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector3) {
  ...
  double alpha = double(0.7696633344695882), beta = double(0.4567795538608136);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.4456129873466974 0.35600869803501073 0.5733413890890883;
 0.35600869803501073 0.751993931488493 1.0540967609523757;
 0.5733413890890883 1.0540967609523757 1.3388541210627483
	)");
