...
TEST(blas_A_withA, blas_syrk_ln_novector3) {
  ...
  double alpha = double(0.7245306166095871), beta = double(0.10327007189726611);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.31995776971318646 0.19132406436826546 0.528485343692765;
 0.19132406436826546 0.6680245034139966 0.6951880746954138;
 0.528485343692765 0.6951880746954138 1.175794642427845
	)");
