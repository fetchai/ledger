...
TEST(blas_A_withA, blas_syrk_ln_novector3) {
  ...
  type alpha = type(0.8213587401180896);
  type beta = type(0.991846019953871);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.6291861537923981 0.601927354560236 0.629195683104163;
 0.601927354560236 0.8640569623449443 1.583545242091637;
 0.629195683104163 1.583545242091637 1.5593050172242966
	)");
