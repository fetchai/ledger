...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector_threaded3)
{
  ...
  type alpha = type(0.5488929209906861), beta = type(0.8409707900205396);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.4747345282886179 0.4806638019069054 0.42660145623969736;
 0.4806638019069054 0.5991676198761139 1.2202339900861339;
 0.42660145623969736 1.2202339900861339 1.0881439546147302
	)");
