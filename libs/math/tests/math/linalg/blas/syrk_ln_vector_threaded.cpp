...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE | platform::Parallelisation::THREADING> syrk_ln_vector_threaded;
...
TEST(blas_A_withA_vectorised, blas_syrk_ln_vector_threaded3) {
  ...
  double alpha = double(0.23639683020067737), beta = double(0.02259454710434905);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.10101328048999877 0.057538733826837204 0.1720502835951641;
 0.057538733826837204 0.21660562890904195 0.21672962818386682;
 0.1720502835951641 0.21672962818386682 0.3807609229292222
	)");
