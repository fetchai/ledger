...
TEST(blas_A_withA, blas_syrk_lt_novector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::THREADING> syrk_lt_novector_threaded;
...
TEST(blas_A_withA, blas_syrk_lt_novector_threaded3) {
  ...
  double alpha = double(0.842421501725733), beta = double(0.8226887988949503);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.3200518073341978 1.2212734283921893 0.7077868127601177;
 1.2212734283921893 0.9104077281923186 1.415038912019382;
 0.7077868127601177 1.415038912019382 0.766988010940518
	)");
