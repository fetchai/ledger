...
TEST(blas_A_withA, blas_syrk_lt_novector_threaded3)
{
  ...
  double alpha = double(0.33929988536689515), beta = double(0.9746935400986255);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.7276444147147304 0.7750573728158682 0.3071969843216639;
 0.7750573728158682 0.44519476035582517 1.1549348977936367;
 0.3071969843216639 1.1549348977936367 0.47540159833145723
	)");
