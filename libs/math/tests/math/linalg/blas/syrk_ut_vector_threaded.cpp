...
TEST(blas_A_withA_vectorised, blas_syrk_ut_vector_threaded3) {
  ...
  double alpha = double(0.5418742193234755), beta = double(0.6496820838320362);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.8858084547974137 0.616099967540325 0.8816087693347567;
 0.616099967540325 0.6003109590516433 0.7507133098039319;
 0.8816087693347567 0.7507133098039319 0.5245359733194129
	)");
