...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector3)
{
  ...
  type alpha = type(0.6347528190250268), beta = type(0.8785053382766923);
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.614930332572701 1.1570084544459274 0.47455752008750623;
 0.5243049208197802 0.7527379231392146 1.005127369877041;
 0.49228159005304306 0.6535295213948347 1.177769275666951
	)");
