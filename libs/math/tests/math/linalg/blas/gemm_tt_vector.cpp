...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector3)
{
  ...
  double alpha = double(0.6558870762295544), beta = double(0.27021092279301373);
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.2542167668974302 0.6077955211567722 0.4339401281375626;
 0.4168139959064084 0.7489661163477609 0.8311807873851501;
 0.2608731726824301 0.5022918776785501 0.6886263842266263
	)");
