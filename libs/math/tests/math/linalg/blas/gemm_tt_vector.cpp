...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector3)
{
  ...
  double alpha = double(0.8000834122764018), beta = double(0.6374239206682937);
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.49414413568275245 1.0251785864081788 0.5565802144769428;
 0.5687752318350251 0.9275471072482514 1.1140543817937247;
 0.437863675376574 0.6962436264902426 1.0951118960317163
	)");
