...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector3)
{
  ...
  double alpha = double(0.7102571843156882), beta = double(0.8259726207022383);
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.594187580472983 1.1498721268761196 0.5171104009178084;
 0.5558959075475384 0.8351745972292062 1.073600933331434;
 0.48980425282529555 0.6886570062519335 1.1877278778626281
	)");
