...
TEST(blas_DGEMM, blas_gemm_tt_novector_threaded4)
{
  ...
  double alpha = double(0.407603208593353), beta = double(0.02409419849842276);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.20543046385625563 0.04779634017483618 0.16096610233672556;
 0.37415227664744666 0.027352277732577167 0.3453009618131234;
 0.2567881275781987 0.05209735943854797 0.2033945911990008
	)");
