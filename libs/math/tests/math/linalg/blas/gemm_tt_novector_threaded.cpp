...
TEST(blas_DGEMM, blas_gemm_tt_novector_threaded4) {
  ...
  double alpha = double(0.29369343974110895), beta = double(0.7959227655169678);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.7155976454987596 0.6349208359887634 0.17363048123719943;
 0.5486785761088333 0.10991959018861375 0.9207818483928336;
 0.6703017320909008 0.29516273112991825 0.19603756727179422
	)");
