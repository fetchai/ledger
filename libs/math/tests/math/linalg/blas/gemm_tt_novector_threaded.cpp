...
TEST(blas_DGEMM, blas_gemm_tt_novector_threaded4)
{
  ...
  type alpha = type(0.29564768816520426), beta = type(0.6690132792790143);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.6239804396780726 0.53717937485476 0.16499670887853993;
 0.5049383332989874 0.09533246240667333 0.812801672006054;
 0.5923584514875238 0.2533801878110523 0.18893924026574327
	)");
