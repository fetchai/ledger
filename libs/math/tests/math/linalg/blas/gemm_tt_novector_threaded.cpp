...
TEST(blas_DGEMM, blas_gemm_tt_novector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::THREADING> gemm_tt_novector_threaded;
...
TEST(blas_DGEMM, blas_gemm_tt_novector_threaded4) {
  ...
  double alpha = double(0.3883047517329836), beta = double(0.22091223144245686);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.3400175002793493 0.198213119141278 0.1680027620020068;
 0.42739903973138915 0.04899455186859545 0.4998111982470329;
 0.36801753947384397 0.11513492458725144 0.20634656812267405
	)");
