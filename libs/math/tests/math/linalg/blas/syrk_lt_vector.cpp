...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector3)
{
  ...
  double alpha = double(0.24921786907894328), beta = double(0.5260425170055991);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.4766205104103551 0.4857100806376259 0.21910853682450643;
 0.4857100806376259 0.30382618782627924 0.6756487845312185;
 0.21910853682450643 0.6756487845312185 0.3000493312056223
	)");
