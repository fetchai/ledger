...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> syrk_lt_vector;
...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector3) {
  ...
  double alpha = double(0.39954599222498843), beta = double(0.3985122735679786);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.6286137692877662 0.5828932692558417 0.3359773707922627;
 0.5828932692558417 0.4328066752181413 0.6786987958641845;
 0.3359773707922627 0.6786987958641845 0.3659235735401267
	)");
