...
TEST(blas_A_withA_vectorised, blas_syrk_lt_vector3) {
  ...
  double alpha = double(0.30186946628609135), beta = double(0.3205492929435704);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.48086535848014583 0.448959790379006 0.2545106182026787;
 0.448959790379006 0.32937391604982114 0.5304742541450436;
 0.2545106182026787 0.5304742541450436 0.2815027537701194
	)");
