...
TEST(blas_A_withA, blas_syrk_lt_novector3) {
  ...
  double alpha = double(0.9508610976923902), beta = double(0.3783544117282702);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.3223649066193452 1.1362934078935591 0.7799740054097136;
 1.1362934078935591 0.9604491854484265 1.0968490017269867;
 0.7799740054097136 1.0968490017269867 0.7233280074460565
	)");
