...
TEST(blas_A_withA, blas_syrk_lt_novector3)
{
  ...
  type alpha = type(0.07282203693318023), beta = type(0.09402419206070578);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.1210882396220789 0.11565438111633097 0.06197148501042641;
 0.11565438111633097 0.08149466082962148 0.14315185005098863;
 0.06197148501042641 0.14315185005098863 0.07222939832294163
	)");
