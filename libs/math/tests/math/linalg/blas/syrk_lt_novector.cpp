...
TEST(blas_A_withA, blas_syrk_lt_novector1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> syrk_lt_novector;
...
TEST(blas_A_withA, blas_syrk_lt_novector3) {
  ...
  double alpha = double(0.8860647281023107), beta = double(0.0443340070349072);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix< double > R = Matrix< double >(R"(
	1.1383590567100923 0.9231892753804781 0.7162228953084886;
 0.9231892753804781 0.8573826798188644 0.7418176780543237;
 0.7162228953084886 0.7418176780543237 0.5942711798779546
	)");
