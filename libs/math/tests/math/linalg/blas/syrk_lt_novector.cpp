...
TEST(blas_A_withA, blas_syrk_lt_novector3)
{
  ...
  double alpha = double(0.8090397400043307), beta = double(0.9822011311942631);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	1.3262634968700677 1.257437944185841 0.6863465332978461;
 1.257437944185841 0.897776976617249 1.53365814770076;
 0.6863465332978461 1.53365814770076 0.7863101567612722
	)");
