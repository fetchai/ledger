...
TEST(blas_gemv, blas_gemv_n_vector3) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_n_vector;
	// Compuing _y = _alpha * _A * _x + _beta * _y
  using type = double;type alpha = type(0.7512359527334447);
...
TEST(blas_gemv, blas_gemv_n_vector5) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_n_vector;
	// Compuing _y = _alpha * _A * _x + _beta * _y
  using type = double;type alpha = type(0.6364757407781164);
...
TEST(blas_gemv, blas_gemv_n_vector6) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE> gemv_n_vector;
	// Compuing _y = _alpha * _A * _x + _beta * _y
  using type = double;type alpha = type(0.7696456800174859);
