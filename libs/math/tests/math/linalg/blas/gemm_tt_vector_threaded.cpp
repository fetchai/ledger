...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector_threaded3) {
  ...
  double alpha = double(0.8742703692232037), beta = double(0.8551134098976934);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.6347811240351052 1.2664326776983705 0.6222221553017029;
 0.6525942999683787 1.0207253799599243 1.2689464943577229;
 0.540102537690176 0.8038340197813727 1.3280804001030768
	)");
