...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector_threaded3)
{
  ...
  type alpha = type(0.5627930448429862), beta = type(0.7126546489803092);
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.5056023973906605 0.964761230814892 0.41489524999272914;
 0.4518809120663373 0.6644059299344953 0.8696239085853478;
 0.41072050306626184 0.5614621825901641 0.989339476509911
	)");
