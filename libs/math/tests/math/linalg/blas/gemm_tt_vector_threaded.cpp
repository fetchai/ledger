...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector_threaded1) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::VECTORISE | platform::Parallelisation::THREADING> gemm_tt_vector_threaded;
...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector_threaded3) {
  ...
  double alpha = double(0.09465741832739172), beta = double(0.8049214797679085);
...
Matrix< double > C = Matrix< double >(R"(
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix< double > R = Matrix< double >(R"(
	0.4946348605692026 0.7938031287910041 0.13040469916350986;
 0.21026258565890016 0.1427312551340519 0.36913429574593437;
 0.3353466806306717 0.2803235393384192 0.7341328927209866
	)");
