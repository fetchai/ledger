...
TEST(blas_gemm_vectorised, blas_gemm_tt_vector_threaded3) {
  ...
  type alpha = type(0.18113226569514884);
  type beta = type(0.8630644122178468);
...
Matrix< type > C = Matrix< type >(R"(
 ...
 0.388677289689482 0.2713490317738959 0.8287375091519293
  ...
  Matrix< type > R = Matrix< type >(R"(
	0.5416148855502044 0.894695427356327 0.18960975345497755;
 0.26963004374906036 0.24249641818434595 0.48604611900912975;
 0.3784932014366799 0.352657788780329 0.8435850848431081
	)");
