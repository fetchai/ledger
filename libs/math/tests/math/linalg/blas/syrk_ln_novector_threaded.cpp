...
TEST(blas_A_withA, blas_syrk_ln_novector_threaded3)
{
  ...
  type alpha = type(0.3530721001545657);
  type beta  = type(0.7742862483922429);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<type> R = Matrix<type>(R"(
	0.376447758058889 0.41188790020242866 0.2824329517452833;
 0.41188790020242866 0.41388701174690895 0.9970861543379929;
 0.2824329517452833 0.9970861543379929 0.7603250064567935
	)");
