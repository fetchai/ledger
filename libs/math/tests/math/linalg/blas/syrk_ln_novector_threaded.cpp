...
TEST(blas_A_withA, blas_syrk_ln_novector_threaded3)
{
  ...
  double alpha = double(0.38215565631823345), beta = double(0.8625036932889188);
 ...
 0.034388521115218396 0.9093204020787821 0.2587799816000169
  ...
  Matrix<double> R = Matrix<double>(R"(
	0.41490076511077334 0.4565724103162119 0.30653812156820576;
 0.4565724103162119 0.4509623479072929 1.1014403005966642;
 0.30653812156820576 1.1014403005966642 0.8292790246232047
	)");
