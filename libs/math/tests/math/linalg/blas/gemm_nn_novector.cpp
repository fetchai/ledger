...
TEST(blas_DGEMM, blas_gemm_nn_novector4) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> gemm_nn_novector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(0.03350148733328795);
 ...
 0.6232981268275579 0.3308980248526492 0.06355835028602363
  ...
  Tensor< Type > ref_tensor_C = Tensor< Type >::FromString(R"(
  0.43068549076835544 0.46002464199889653 0.051568825293934265;
...
TEST(blas_DGEMM, blas_gemm_nn_novector7) {
	...
	Blas< double, 
        ...
        platform::Parallelisation::NOT_PARALLEL> gemm_nn_novector;
	// Compuing _C <= _alpha * _A * _B + _beta * _C
  using Type = double;Type alpha = Type(1.8006387209765764);
 ...
 0.1014715428660321 0.6635017691080558 0.005061583846218687 0.16080805141749865 0.5487337893665861 0.6918951976926933 0.6519612595026005 0.22426930946055978 0.7121792213475359
  ...
  Tensor< Type > ref_tensor_C = Tensor< Type >::FromString(R"(
  1.6231128659159049 0.24876394147896413 1.2682621501788753 -0.4375950365914927 1.0091439698527114 0.33578137234930294 0.7346297340753531 -0.09001273179803593 1.6314038385664893;
