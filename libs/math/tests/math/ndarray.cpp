...
int main(int argc, char **argv) {
  ...
  c.in_parallel().Apply([](vector_register_type const&x, vector_register_type const&y, vector_register_type &z) {
      z = x + y;      
    }, a, b);
  ...
  */
  ...
  std::cout << "Did this break? " <<   a.in_parallel().SumReduce(TrivialRange(SS,BB+1), [](vector_register_type const &x, vector_register_type const &y, vector_register_type const &z) {
      return (x + y) * z;
    }, b, c) << std::endl;
  ...
  /*
  b.in_parallel().Apply(TrivialRange(100, 599), [](vector_register_type const &x, vector_register_type &y) {
      y = x;      
    }, a);
