...
Tensor<data_type> RandomArray(std::size_t n, data_type adj)
{
  static fetch::random::LinearCongruentialGenerator gen;
  Tensor<data_type>         a1(n);
...
Tensor<data_type> ConstantArray(std::size_t n, data_type adj)
{
  Tensor<data_type> a1(n);
  for (std::size_t i = 0; i < n; ++i)
  {
...
{
  std::size_t                               n            = 1000;
  Tensor<data_type> test_array   = ConstantArray(n, 0);
  Tensor<data_type> test_array_2 = RandomArray(n, -1.0);
...
{
  std::size_t                               n            = 1000;
  Tensor<data_type> test_array   = RandomArray(n, -1.0);
  Tensor<data_type> test_array_2 = RandomArray(n, 1.0);
