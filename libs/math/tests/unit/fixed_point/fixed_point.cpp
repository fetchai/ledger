...
TEST(FixedPointTest, Constants_16_16)
{
  ...
  EXPECT_TRUE(fp32_t::CONST_TWO_INV_PI == fp32_t(0, 0xA2F9)); // 0 .636619772367581343075535053490057448
  EXPECT_TRUE(fp32_t::CONST_TWO_INV_SQRTPI.Near(1.128379167095512573896158903121545172));
  EXPECT_TRUE(fp32_t::CONST_TWO_INV_SQRTPI == fp32_t(1, 0x20DD)); // 1.128379167095512573896158903121545172
  ...
  EXPECT_TRUE(fp32_t::CONST_INV_SQRT2 == fp32_t(0, 0xB504)); // 0.707106781186547524400844362104849039
...
TEST(FixedPointTest, Constants_32_32)
{
  ...
  EXPECT_TRUE(fp64_t::CONST_LOG2E == fp64_t(1, 0x71547652)); // 1.442695040888963407359924681001892137
  ...
  EXPECT_TRUE(fp64_t::CONST_LOG10E == fp64_t(0, 0x6F2DEC54)); // 0.434294481903251827651128918916605082
  EXPECT_TRUE(fp64_t::CONST_LN2.Near(0.693147180559945309417232121458176568));
  EXPECT_TRUE(fp64_t::CONST_LN2 == fp64_t(0, 0xB17217F7)); // 0.693147180559945309417232121458176568
  EXPECT_TRUE(fp64_t::CONST_LN10.Near(2.302585092994045684017991454684364208));
  EXPECT_TRUE(fp64_t::CONST_LN10 == fp64_t(2, 0x4D763776)); // 2.302585092994045684017991454684364208
  ...
  EXPECT_TRUE(fp64_t::CONST_PI_2 == fp64_t(1, 0x921FB544)); // 1.570796326794896619231321691639751442
  EXPECT_TRUE(fp64_t::CONST_PI_4.Near(0.785398163397448309615660845819875721));
  EXPECT_TRUE(fp64_t::CONST_PI_4 == fp64_t(0, 0xC90FDAA2)); // 0.785398163397448309615660845819875721
  EXPECT_TRUE(fp64_t::CONST_INV_PI.Near(0.318309886183790671537767526745028724));
  EXPECT_TRUE(fp64_t::CONST_INV_PI == fp64_t(0, 0x517CC1B7)); // 0.318309886183790671537767526745028724
  EXPECT_TRUE(fp64_t::CONST_TWO_INV_PI.Near(0.636619772367581343075535053490057448));
  EXPECT_TRUE(fp64_t::CONST_TWO_INV_PI == fp64_t(0, 0xA2F9836E)); // 0 .636619772367581343075535053490057448
  EXPECT_TRUE(fp64_t::CONST_TWO_INV_SQRTPI.Near(1.128379167095512573896158903121545172));
  EXPECT_TRUE(fp64_t::CONST_TWO_INV_SQRTPI == fp64_t(1, 0x20DD7504)); // 1.128379167095512573896158903121545172
  EXPECT_TRUE(fp64_t::CONST_SQRT2.Near(1.414213562373095048801688724209698079));
  EXPECT_TRUE(fp64_t::CONST_SQRT2 == fp64_t(1, 0x6A09E667)); // 1.414213562373095048801688724209698079
  EXPECT_TRUE(fp64_t::CONST_INV_SQRT2.Near(0.707106781186547524400844362104849039));
  EXPECT_TRUE(fp64_t::CONST_INV_SQRT2 == fp64_t(0, 0xB504F333)); // 0.707106781186547524400844362104849039
...
TEST(FixedPointTest, Constants_64_64)
{
  ...
  EXPECT_TRUE(fp128_t::CONST_E == fp128_t(2, 0xB7E151628AED2A6A)); // 2.718281828459045235360287471352662498
  EXPECT_TRUE(fp128_t::CONST_LOG2E.Near(1.442695040888963407359924681001892137));
  EXPECT_TRUE(fp128_t::CONST_LOG2E == fp128_t(1, 0x71547652B82FE177)); // 1.442695040888963407359924681001892137
  ...
  EXPECT_TRUE(fp128_t::CONST_LOG10E == fp128_t(0, 0x6F2DEC549B9438CA)); // 0.434294481903251827651128918916605082
  EXPECT_TRUE(fp128_t::CONST_LN2.Near(0.693147180559945309417232121458176568));
  EXPECT_TRUE(fp128_t::CONST_LN2 == fp128_t(0, 0xB17217F7D1CF79AB)); // 0.693147180559945309417232121458176568
  EXPECT_TRUE(fp128_t::CONST_LN10.Near(2.302585092994045684017991454684364208));
  EXPECT_TRUE(fp128_t::CONST_LN10 == fp128_t(2, 0x4D763776AAA2B05B)); // 2.302585092994045684017991454684364208
  EXPECT_TRUE(fp128_t::CONST_PI.Near(3.141592653589793238462643383279502884));
  EXPECT_TRUE(fp128_t::CONST_PI == fp128_t(3, 0x243F6A8885A308D3)); // 3.141592653589793238462643383279502884
  EXPECT_TRUE(fp128_t::CONST_PI_2.Near(1.570796326794896619231321691639751442));
  EXPECT_TRUE(fp128_t::CONST_PI_2 == fp128_t(1, 0x921FB54442D18469)); // 1.570796326794896619231321691639751442
  EXPECT_TRUE(fp128_t::CONST_PI_4.Near(0.785398163397448309615660845819875721));
  EXPECT_TRUE(fp128_t::CONST_PI_4 == fp128_t(0, 0xC90FDAA22168C234)); // 0.785398163397448309615660845819875721
  EXPECT_TRUE(fp128_t::CONST_INV_PI.Near(0.318309886183790671537767526745028724));
  EXPECT_TRUE(fp128_t::CONST_INV_PI == fp128_t(0, 0x517CC1B727220A94)); // 0.318309886183790671537767526745028724
  EXPECT_TRUE(fp128_t::CONST_TWO_INV_PI.Near(0.636619772367581343075535053490057448));
  EXPECT_TRUE(fp128_t::CONST_TWO_INV_PI == fp128_t(0, 0xA2F9836E4E441529)); // 0 .636619772367581343075535053490057448
  EXPECT_TRUE(fp128_t::CONST_TWO_INV_SQRTPI.Near(1.128379167095512573896158903121545172));
  EXPECT_TRUE(fp128_t::CONST_TWO_INV_SQRTPI == fp128_t(1, 0x20DD750429B6D11A)); // 1.128379167095512573896158903121545172
  EXPECT_TRUE(fp128_t::CONST_SQRT2.Near(1.414213562373095048801688724209698079));
  EXPECT_TRUE(fp128_t::CONST_SQRT2 == fp128_t(1, 0x6A09E667F3BCC908)); // 1.414213562373095048801688724209698079
  EXPECT_TRUE(fp128_t::CONST_INV_SQRT2.Near(0.707106781186547524400844362104849039));
  EXPECT_TRUE(fp128_t::CONST_INV_SQRT2 == fp128_t(0, 0xB504F333F9DE6484)); // 0.707106781186547524400844362104849039
