#ifndef MATH_DISTANCE_JACCARD_HPP
#define MATH_DISTANCE_JACCARD_HPP
...
inline typename memory::VectorSlice<T, S>::type Jaccard(
...
inline typename ShapeLessArray<T, C>::type Jaccard(
...
template <typename T, typename C>
inline typename ShapeLessArray<T, C>::type GeneralisedJaccard(
    ShapeLessArray<T, C> const &a, ShapeLessArray<T, C> const &b)
{
