...
namespace fetch {
    namespace math {
        namespace distance {
            ...
            void ConditionalProbabilitiesDistance(ArrayType const &a, size_t i, size_t j, typename ArrayType::Type const sigma, typename ArrayType::Type &r)
            {
            ...
            template <typename ArrayType>
            typename ArrayType::Type ConditionalProbabilitiesDistance(ArrayType const &a, int i, int j, typename ArrayType::Type const sigma)
            {
