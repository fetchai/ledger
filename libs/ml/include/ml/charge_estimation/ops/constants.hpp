...
static constexpr OperationsCount OP_MATRIX_MULTIPLY_OVERHEAD = 200;
static constexpr OperationsCount OP_MATRIX_MULTIPLY_FORWARD  = 25;
...
static constexpr OperationsCount MEAN_SQ_ERROR_BACKWARD_OVERHEAD         = 450;
static constexpr OperationsCount LOW_MEAN_SQ_ERROR_BACKWARD_PER_ELEMENT  = 15;
static constexpr OperationsCount HIGH_MEAN_SQ_ERROR_BACKWARD_PER_ELEMENT = 75;
