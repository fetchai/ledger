...
static constexpr OperationsCount LOW_ADDITION_PER_ELEMENT         = 6;
static constexpr OperationsCount HIGH_ADDITION_PER_ELEMENT        = 25;
...
static constexpr OperationsCount GELU_PER_ELEMENT =
    ...
    +LOW_ADDITION_PER_ELEMENT + TANH_PER_ELEMENT + LOW_ADDITION_PER_ELEMENT + MULTIPLICATION_PER_ELEMENT +
    MULTIPLICATION_PER_ELEMENT;
