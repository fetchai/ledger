...
/**
 * serialiser for Model
 * @tparam TensorType
 */
template <typename TensorType, typename D>
struct MapSerialiser<ml::model::Model<TensorType>, D>
{
  ...
  static void SerialiseDataLoader(MapType map, Type const &sp)
  {
  ...
  template <typename MapType>
  static void SerialiseOptimiser(MapType map, Type const &sp)
  {
  ...
  template <typename MapType>
  static void DeserialiseDataLoader(MapType map, Type &sp)
  {
    uint8_t loader_type{};
  ...
  template <typename MapType>
  static void DeserialiseOptimiser(MapType map, Type &sp)
  {
  ...
  static void Serialise(Constructor &map_constructor, Type const &sp)
  {
    ...
    // serialise dataloader
    SerialiseDataLoader(map, sp);

    // serialise optimiser
    SerialiseOptimiser(map, sp);
  ...
  static void Deserialise(MapDeserialiser &map, Type &sp)
  {
    ...
    // deserialise dataloader
    DeserialiseDataLoader(map, sp);

    // deserialise optimiser
    DeserialiseOptimiser(map, sp);
