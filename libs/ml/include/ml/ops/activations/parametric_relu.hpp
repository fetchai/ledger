...
#include "math/ml/activation_functions/parametric_relu.hpp"
...
template <class T>
class PRelu : public fetch::ml::ElementWiseOps<T>
{
public:
  using ArrayType    = T;
  ...
  virtual ArrayType Forward(std::vector<std::reference_wrapper<ArrayType const>> const &inputs)
  {
    ...
    fetch::math::PRelu(inputs.front().get(), a_, *this->output_);
  ...
  static constexpr char const *DESCRIPTOR = "PRelu";
