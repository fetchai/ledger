...
struct AbsSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::ABS;
...
struct GraphSaveableParams : public SaveableParamsInterface
{
  ...
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::GRAPH;
...
{
  using SizeType                        = typename TensorType::SizeType;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::SUBGRAPH;
...
struct AddSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::ADD;
...
struct Convolution1DSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::CONVOLUTION_1D;
...
struct Convolution2DSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::CONVOLUTION_2D;
  fetch::math::SizeType   stride_size   = fetch::math::numeric_max<fetch::math::SizeType>();
...
struct CrossEntropyLossSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::CROSS_ENTROPY_LOSS;
  fetch::math::SizeType   stride_size   = fetch::math::numeric_max<fetch::math::SizeType>();
...
struct DivideSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::DIVIDE;
...
struct DropoutSaveableParams : public SaveableParamsInterface
{
  ...
  using DataType                        = typename TensorType::Type;
  using SizeType                        = typename TensorType::SizeType;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::DROPOUT;
...
struct EluSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::ELU;
...
struct EmbeddingsSaveableParams : public WeightsSaveableParams<TensorType>
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::EMBEDDINGS;
...
struct ExpSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::EXP;
...
struct FlattenSaveableParams : public SaveableParamsInterface
{
  ...
  {}
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::FLATTEN;
...
{
  using SizeType                        = typename TensorType::SizeType;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::LAYER_FULLY_CONNECTED;
...
struct LeakyReluSaveableParams : public SaveableParamsInterface
{
  using DataType = typename TensorType::Type;
  DataType                a;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::LEAKY_RELU;
...
struct LeakyReluOpSaveableParams : public SaveableParamsInterface
{
  using DataType = typename TensorType::Type;
  DataType                a;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::LEAKY_RELU_OP;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::LOG;
...
struct LogSigmoidSaveableParams : public SaveableParamsInterface
{
  using DataType = typename TensorType::Type;
  DataType                a;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::LOGSIGMOID;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::MEAN_SQUARE_ERROR_LOSS;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::MAXIMUM;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::MULTIPLY;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::RELU;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::SIGMOID;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::SOFTMAX_CROSS_ENTROPY_LOSS;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::SQRT;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::SUBTRACT;
...
{
  using DataType                        = typename TensorType::Type;
  const fetch::ml::OpType OP_DESCRIPTOR = OpType::TANH;
...
//}
//
// template <class S, class TensorType>
