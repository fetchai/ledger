...
void ReshapeTestForward(std::vector<SizeType> const& initial_shape, std::vector<SizeType> const& final_shape)
{
...
template <typename TensorType>
void ReshapeTestForwardWrong(std::vector<SizeType> const& initial_shape, std::vector<SizeType> const& final_shape)
{
  TensorType data(initial_shape);
  TensorType gt(final_shape);
  fetch::ml::ops::Reshape<TensorType> op(final_shape);
...
//
//template <typename TensorType>
//void ReshapeTestBackward(std::vector<SizeType> const& initial_shape, std::vector<SizeType> const& final_shape)
//{
//  TensorType data(initial_shape);
//  TensorType gt(final_shape);
//  fetch::ml::ops::Reshape<TensorType> op(final_shape);
...
//
//TYPED_TEST(ReshapeTest, backward_2_2_2_test)
//{
