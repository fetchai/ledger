...
TYPED_TEST(Convolution1DTest, ops_backward_test)  // Use the class as an Ops
{
  ...
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(0, 0, 0)), -4.3077492713928222656, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(1, 0, 0)), 9.162715911865234375, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(2, 0, 0)), 0.80360949039459228516, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(0, 1, 0)), 1.2491617202758789062, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(1, 1, 0)), 2.8053097724914550781, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(2, 1, 0)), -4.166011810302734375, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(0, 2, 0)), 2.4086174964904785156, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(1, 2, 0)), -0.86411559581756591797, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(backprop_error.at(0).At(2, 2, 0)), -3.5623354911804199219, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
}
...
TYPED_TEST(Convolution1DTest, node_forward_test)  // Use the class as a Node
{
  ...
  ASSERT_TRUE(prediction.AllClose(gt, math::function_tolerance<DataType>(), math::function_tolerance<DataType>()));
}
...
TYPED_TEST(Convolution1DTest, node_backward_test)  // Use the class as a Node
{
  ...
  EXPECT_NEAR(static_cast<double>(err_signal.At(0, 0, 0)), -4.3077492713928222656, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(1, 0, 0)), 9.162715911865234375, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(2, 0, 0)), 0.80360949039459228516, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(0, 1, 0)), 1.2491617202758789062, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(1, 1, 0)), 2.8053097724914550781, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(2, 1, 0)), -4.166011810302734375, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(0, 2, 0)), 2.4086174964904785156, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(1, 2, 0)), -0.86411559581756591797, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(err_signal.At(2, 2, 0)), -3.5623354911804199219, kernel_height * static_cast<double>(math::function_tolerance<DataType>()));
}
...
TYPED_TEST(Convolution1DTest, getStateDict)
{
  ...
  EXPECT_NEAR(static_cast<double>(weights_ptr->At(0, 0, 0, 0)), -0.970493f, static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(weights_ptr->At(1, 1, 1, 0)), 0.55109727f, static_cast<double>(math::function_tolerance<DataType>()));
  EXPECT_NEAR(static_cast<double>(weights_ptr->At(4, 2, 2, 0)), -0.97583634f, static_cast<double>(math::function_tolerance<DataType>()));
}
