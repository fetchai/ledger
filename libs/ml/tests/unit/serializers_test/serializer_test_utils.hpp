 ...
 * @return
 */
template <typename OpKind, typename TensorType, typename LayerType>
std::shared_ptr<OpKind> SerialiseDeserialiseBuild(LayerType &layer)
{
  // serialize
  ...
  // deserialize
  b.seek(0);
  auto layer2 = std::make_shared<OpKind>();
  b >> layer2;
