...
TYPED_TEST(SparseOptimisersTest, lazy_adam_optimiser_training_2D)
{
  ...
  EXPECT_NEAR(static_cast<double>(weights[0].At(7, 0)), -0.12178755993954837,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(3, 4)), 0.068500809411668778,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(8, 32)), 0.006469392217695713,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(0, 9)), 0.10789377149194479,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
...
TYPED_TEST(SparseOptimisersTest, adam_optimiser_training_2D)
{
  ...
  // Test weights
  std::vector<TypeParam> weights = g->GetWeights();
  EXPECT_NEAR(static_cast<double>(weights[0].At(7, 0)), -0.12178755970671773,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(3, 4)), 0.062542634550482035,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(8, 32)), 0.006469392217695713,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
  EXPECT_NEAR(static_cast<double>(weights[0].At(0, 9)), 0.10191486566327512,
              static_cast<double>(fetch::math::function_tolerance<DataType>()) * 2 *
                  static_cast<double>(gt_1.size()));
