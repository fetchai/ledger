...
template <typename T>
class SerialisersTestWithInt : public ::testing::Test
{
};

template <typename T>
class SerialisersTestNoInt : public ::testing::Test
{
};
...
TYPED_TEST_SUITE(SerialisersTestWithInt, ::fetch::math::test::TensorIntAndFloatingTypes, );
TYPED_TEST_SUITE(SerialisersTestNoInt, ::fetch::math::test::TensorFloatingTypes, );
...
TYPED_TEST(SerialisersTestWithInt, serialise_empty_graph_saveable_params)
{
...
TYPED_TEST(SerialisersTestNoInt, serialise_graph_saveable_params)
{
  ...
  ::fetch::serialisers::LargeObjectSerialiseHelper b;
  b.Serialise(gsp1);
