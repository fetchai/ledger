           ...
           self_attention_backward_exact_value_test_with_mask)  // Use the class as a layer
{
	...
	TypeParam error_signal = TypeParam::FromString("1, 1, 0, -1.5, 0, 0; 1, 3, 0, 4, 0, 0; 1, 2.5, 0, 0, 0, 0");
  error_signal.Reshape({3, 3, 2});
   ...
   "0.2949745039,  0.0189728892,  0.0000000000,  0.0000000000,0.0000000000,  0.0000000000");
	...
	TypeParam gt_value_grad = TypeParam::FromString("0.1558327790,  1.8441672210,  0.0000000000, -1.5000000000, 0.0000000000,  0.0000000000; "
