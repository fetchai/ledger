...
template <typename T>
class BatchwiseFlattenTest : public ::testing::Test
{
};
...
TYPED_TEST_CASE(BatchwiseFlattenTest, MyTypes);

TYPED_TEST(BatchwiseFlattenTest, forward_test)
{
...
TYPED_TEST(BatchwiseFlattenTest, backward_test)
{
  using SizeType = typename TypeParam::SizeType;
  using DataType = typename TypeParam::Type;
