...
{
  std::shared_ptr<fetch::math::NDArray<float>> data = std::make_shared<fetch::math::NDArray<float>>(8);
  std::shared_ptr<fetch::math::NDArray<float>> gt = std::make_shared<fetch::math::NDArray<float>>(8);
  std::vector<float> dataInput({1.1f, -2.22f, 3.333f, -4.4444f, 5.55555f, -6.666666f, 7.7777777f, -8.88888888f});
