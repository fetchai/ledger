...
template class Graph<math::Tensor<uint8_t>>;
template class Graph<math::Tensor<uint16_t>>;
template class Graph<math::Tensor<uint32_t>>;
template class Graph<math::Tensor<uint64_t>>;
