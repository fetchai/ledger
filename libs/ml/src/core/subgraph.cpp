...
template class SubGraph<math::Tensor<uint8_t>>;
template class SubGraph<math::Tensor<uint16_t>>;
template class SubGraph<math::Tensor<uint32_t>>;
template class SubGraph<math::Tensor<uint64_t>>;
