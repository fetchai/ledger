...
template class PRelu<math::Tensor<uint8_t>>;
template class PRelu<math::Tensor<uint16_t>>;
template class PRelu<math::Tensor<uint32_t>>;
template class PRelu<math::Tensor<uint64_t>>;
