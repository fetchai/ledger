...
template <typename TensorType>
std::vector<math::SizeType> Gelu<TensorType>::ComputeOutputShape(
...
template <typename TensorType>
std::pair<OperationsCount, math::SizeVector> Gelu<TensorType>::ChargeForward(
    std::vector<math::SizeVector> const &input_shapes)
{
  assert(!this->batch_input_shapes_.empty());

  OperationsCount op_cnt = fetch::ml::charge_estimation::ops::GELU_PER_ELEMENT *
...
template <typename TensorType>
std::pair<OperationsCount, math::SizeVector> Gelu<TensorType>::ChargeBackward(
    std::vector<math::SizeVector> const &input_shapes)
{
  assert(!this->batch_input_shapes_.empty());
