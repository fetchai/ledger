...
int main(int ac, char **av)
{
  ...
  g.AddNode<fetch::ml::ops::PlaceHolder<ArrayType>>("Input_Context", {}); // A list of IDs of the context words
  g.AddNode<fetch::ml::ops::AveragedEmbeddings<ArrayType>>("Embeddings", {"Input_Context"}, loader.VocabSize(), EMBEDDING_DIMENSION); // This embedding matrix will contain the word vectors
  g.AddNode<fetch::ml::ops::PlaceHolder<ArrayType>>("Input_Target", {}); // The ID of the target word
  g.AddNode<fetch::ml::ops::Embeddings<ArrayType>>("Weights", {"Input_Target"}, loader.VocabSize(), EMBEDDING_DIMENSION); // This embedding matrix will contain weights
  ...
  g.AddNode<fetch::ml::ops::MatrixMultiply<ArrayType>>("Dot", {"Embeddings", "Transpose"}); // Dot Product Vector x Weights
