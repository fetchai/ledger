...
template <class T>
class SkipGramOptimisedEmbeddings : public fetch::ml::ops::Weights<T>
{
public:
  using ArrayType      = T;
  ...
  SkipGramOptimisedEmbeddings(SizeType dataPoints, SizeType dimensions)
  {
  ...
  SkipGramOptimisedEmbeddings(ArrayType &weights)
  {
    this->SetData(weights);
  }

  virtual ~SkipGramOptimisedEmbeddings() = default;
