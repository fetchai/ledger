...
BENCHMARK_TEMPLATE(BM_CrossEntropyForward, float, 2, 2)->Unit(benchmark::kMicrosecond);
 ...
 BENCHMARK_TEMPLATE(BM_CrossEntropyBackward, float, 2, 2)->Unit(benchmark::kMicrosecond);
  ...
  BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, float, 2, 2)->Unit(benchmark::kMicrosecond);
   ...
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, double, 1000, 1000)->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, double, 2000, 2000)->Unit(benchmark::kMillisecond);
   ...
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
       ->Unit(benchmark::kMillisecond);
   ...
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
       ->Unit(benchmark::kMillisecond);
   ...
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
       ->Unit(benchmark::kMillisecond);
   BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
       ->Unit(benchmark::kMillisecond);
   ...
   template <class T, int I, int B>
    ...
    BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, float, 2, 2)->Unit(benchmark::kMicrosecond);
     ...
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, float, 1000, 1000)->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, float, 2000, 2000)->Unit(benchmark::kMillisecond);
     ...
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, double, 1000, 1000)->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, double, 2000, 2000)->Unit(benchmark::kMillisecond);
     ...
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
         ->Unit(benchmark::kMillisecond);
     ...
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
         ->Unit(benchmark::kMillisecond);
     ...
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
         ->Unit(benchmark::kMillisecond);
     BENCHMARK_TEMPLATE(BM_MeanSquareErrorLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
         ->Unit(benchmark::kMillisecond);
*/
     template <class T, int I, int B>
       void BM_SoftmaxCrossEntropyLossForward(benchmark::State &state)
       {
        ...
        //std::cout << "test_results: " <<Sum(fetch::math::Softmax((*inputs.at(0)))) << std::endl;
        //std::cout << "ground_truth: " <<DataType(inputs.at(0)->shape().at(1)) << std::endl;
        //std::cout << "difference: " << Sum(fetch::math::Softmax((*inputs.at(0)))) - (DataType(inputs.at(0)->shape().at(1))) << std::endl;
       ...
       //BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, float, 2, 2)->Unit(benchmark::kMicrosecond);
        ...
        //BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, float, 100, 100)->Unit(benchmark::kMillisecond);
        //BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, float, 1000, 1000)->Unit(benchmark::kMillisecond);
        //BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, float, 2000, 2000)->Unit(benchmark::kMillisecond);
/*
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, double, 2, 2)->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, double, 10, 10)->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, double, 100, 100)->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, double, 1000, 1000)->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, double, 2000, 2000)->Unit(benchmark::kMillisecond);

        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2, 2)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 10, 10)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
            ->Unit(benchmark::kMillisecond);

        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2, 2)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 10, 10)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
            ->Unit(benchmark::kMillisecond);

        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2, 2)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 10, 10)
            ->Unit(benchmark::kMicrosecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
            ->Unit(benchmark::kMillisecond);
        BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossForward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
            ->Unit(benchmark::kMillisecond);
*/
        template <class T, int I, int B>
           ...
           BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, float, 2, 2)->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, float, 10, 10)->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, float, 100, 100)->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, float, 1000, 1000)->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, float, 2000, 2000)->Unit(benchmark::kMillisecond);

            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, double, 2, 2)->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, double, 10, 10)->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, double, 100, 100)->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, double, 1000, 1000)->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, double, 2000, 2000)->Unit(benchmark::kMillisecond);

            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2, 2)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 10, 10)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 100, 100)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 1000, 1000)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<16, 16>, 2000, 2000)
                ->Unit(benchmark::kMillisecond);

            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2, 2)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 10, 10)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 100, 100)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 1000, 1000)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<32, 32>, 2000, 2000)
                ->Unit(benchmark::kMillisecond);

            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2, 2)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 10, 10)
                ->Unit(benchmark::kMicrosecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 100, 100)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 1000, 1000)
                ->Unit(benchmark::kMillisecond);
            BENCHMARK_TEMPLATE(BM_SoftmaxCrossEntropyLossBackward, fetch::fixed_point::FixedPoint<64, 64>, 2000, 2000)
                ->Unit(benchmark::kMillisecond);
