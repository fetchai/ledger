...
Status const CLIENT_ERROR_PROXY_AUTHENTICATION_REQUIRED   = {407,
...
Status const CLIENT_ERROR_REQUEST_HEADER_FIELDS_TOO_LARGE = {431,
                                                             "431 Request Header Fields Too Large"};
Status const CLIENT_ERROR_UNAVAILABLE_FOR_LEGAL_REASONS   = {451,
...
Status const SERVER_ERROR_NETWORK_AUTHENTICATION_REQUIRED = {511,
