...
void OefFunctionsTaskFactory::ProcessMessage(ConstCharArrayBuffer &data)
{
  ...
  try
  {
    ...
    case fetch::oef::pb::Envelope::kRegisterService:
    {
      ...
      convTask->SetDefaultSendReplyFunction(LOGGING_NAME, "kRegisterService REPLY ");
      convTask->submit();
      break;
    }
    case fetch::oef::pb::Envelope::kUnregisterService:
    {
      ...
      auto convTask = std::make_shared<SearchRemoveTask>(
          ...
          outbounds, GetEndpoint(), envelope.msg_id(), core_key_, uri.AgentPartAsString());
      convTask->SetDefaultSendReplyFunction(LOGGING_NAME, "kUnregisterService REPLY ");
      convTask->submit();
      break;
    }
    case fetch::oef::pb::Envelope::kSearchAgents:
    {
      ...
      convTask->SetDefaultSendReplyFunction(LOGGING_NAME, "kSearchAgents ");
      convTask->submit();
      break;
    }
    case fetch::oef::pb::Envelope::kSearchServices:
    {
      ...
      convTask->SetDefaultSendReplyFunction(LOGGING_NAME, "kSearchServices ");
      convTask->submit();
      break;
    }
    case fetch::oef::pb::Envelope::kSearchServicesWide:
    {
      ...
      convTask->SetDefaultSendReplyFunction(LOGGING_NAME, "kSearchServicesWide ");
      convTask->submit();
      break;
    }
