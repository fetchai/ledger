...
htmlhelp_basename = 'fetch-vectorisationdoc'
...
man_pages = [
    (master_doc, 'fetch-vectorisation', u'fetch-vectorisation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fetch-vectorisation', u'fetch-vectorisation Documentation',
     author, 'fetch-vectorisation', 'One line description of project.',
     'Miscellaneous'),
]
